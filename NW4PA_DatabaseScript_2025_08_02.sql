USE [NWPADev]
GO
/****** Object:  Schema [AdminSPs]    Script Date: 8/2/2025 9:12:19 AM ******/
CREATE SCHEMA [AdminSPs]
GO
/****** Object:  Schema [BackupSPs]    Script Date: 8/2/2025 9:12:19 AM ******/
CREATE SCHEMA [BackupSPs]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_FullName]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [dbo].[fn_FullNameLF]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  View [dbo].[vw_StockAvailable]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(SELECT ProductID,  
		Max(StockTakeDate) AS LastStockTakeDate
 FROM Stocktake
 GROUP BY ProductID
),
LastStockTakeQOH AS
(SELECT ST.ProductID,
 ...
 AND Cast(ST.StockTakeDate as Date)  =cast(LSTD.LastStockTakeDate as date)
 ),
ProductBought AS
...
WHERE POD.ReceivedDate  > LSTD.LastStockTakeDate 
...
GO
/****** Object:  View [dbo].[vw_ProductList]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(SELECT  [ProductID],ProductsAvailabletoSell AS ToSell
  FROM [NWPADev].[dbo].[vw_StockAvailable]
),
QuantityOnOrder AS
...
GO
/****** Object:  View [dbo].[vw_CompaniesFieldNames]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_Contacts]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_EmployeeOrders]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
, OS.OrderStatusName
GO
/****** Object:  View [dbo].[vw_employees]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(SELECT 
  EP.EmployeeID
, EP.PrivilegeID,P.PrivilegeName
...
GO
/****** Object:  View [dbo].[vw_nwpaTableColumn]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
, DF AS (
		  SELECT 
			...
			, name	AS DF_Name
			, definition AS DF_Value
		  FROM [sys].[default_constraints]
)
SELECT 
		CONCAT(object_id, '.', col.column_id) AS TableColumn_ID
		, tbl.Table_ID
		, Table_Name
...
WHERE col.name not in ('AddedBy',
					   ...
					   'SSMA_TimeStamp')
GO
/****** Object:  View [dbo].[vw_nwpaTableColumnwAuditFields]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
FROM sys.columns AS col
	...
	LEFT JOIN DF
		...
		AND col.column_id = DF.Column_ID
GO
/****** Object:  View [dbo].[vw_OrderList]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(
	SELECT 
		  O .OrderID
		, IsNull(Sum([Quantity]*(1-[Discount])*[UnitPrice]),0) AS OrderTotal 
...
GO
/****** Object:  View [dbo].[vw_PODetails_AllPOs]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_PurchaseOrderList]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(
	SELECT 
		  PO.PurchaseOrderID
		, IsNull(Sum([Quantity]*UnitCost),0) AS PurchaseOrderTotal 
...
GO
/****** Object:  StoredProcedure [AdminSPs].[AddOrUpdateExtendedProperty]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [AdminSPs].[DataTypingForPowerApps]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
 
CREATE PROCEDURE [AdminSPs].[ProblemsinDataTypingForPowerApps]
...
--| ------- | ------------------------------------------ | ------------------------------------ | ------------------------------------------- |
--| `INT`   | Passed as `''` (empty string)              | Conversion failure or silent `0`     | Accept as `NVARCHAR`, `TRY_CAST` to int     |
--| `MONEY` | Passed as `''` or `0.00`                   | Incorrect assumptions or zeroing out | Same as above                               |
--| `DATE`  | Often passed as `'1900-01-01'` or `''`     | Epoch default if not handled         | Accept as `NVARCHAR`, normalize to datetime |
--| `BIT`   | Usually handled OK, but still inconsistent | Misinterpretation of false/null      | Explicit coercion to null/non-null if needed|

END
GO
/****** Object:  StoredProcedure [AdminSPs].[FixEqualSignSpacing]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [AdminSPs].[GetDynamicFilteredData]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [AdminSPs].[GetExtendedProperty]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [AdminSPs].[ListFieldsByDataType]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [AdminSPs].[ListRequiredFieldsByTable]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [AdminSPs].[RebuildInventory]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Description: Reset All Product Inventory to pre-sales status
			 ...
			 Uses defaults for Vendor, SubmittedBy and ApprovedBy
===============================================================
*/
...
BEGIN
	...
	BEGIN Try
		...
		Values
		   (
			   11, -- Default VendorID
			   5, --Default SubmittedByID
			   @BusinessStartDate,--SubmittedDate
			   2, --DefaultApprovedByID
...
END
GO
/****** Object:  StoredProcedure [AdminSPs].[ReindexEntireDatabase]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [AdminSPs].[RemoveDevTestDataFromNWDev]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [BackupSPs].[CRUDOrderDetails]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [BackupSPs].[CRUDPurchaseOrders]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [BackupSPs].[CustomErrorMessage_V2]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [BackupSPs].[ProductList]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [BackupSPs].[UpdatePOStatus]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddNewProductToStockTake]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AllocateInventory]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Author: George Hepworth
Stored Procedure: AllocateInventory
Description: Called by receive a purchase order in order to allocate inventory
Allocates Products received in a New PO Details to orders awaiting fulfillment 
Notes:
  * Uses cursor for clarity in demo; consider set-based logic for production
  * Assumes AddNewProductToStockTake has been run already; call is defensive
Create date: 4/24/2025
Update date: 7/31/2025
=============================================
*/
...
BEGIN
	...
	BEGIN Try 
		...
		BEGIN TRANSACTION;
			BEGIN 
			--Get inventory status from helper procedures
			--Parameters required for the current allocation include:
				--LastStockTakeDate
				--ProductAvailable in Stock
				--ProductOnOrder
			--1. Get the last StockTake date for the product to use in the ProductAvailable procedure in Step 2
			...
			--2. Get the currently available quantity of the product prior to receiving this PO (i.e. stock currently in our warehouse)
			EXEC [dbo].[ProductAvailable]
				...
				@AvailableProductID = @ProductID OUTPUT,
			...
			--3. Get the quantity on Order  (i.e. stock on trucks on the way to our warehouse)
			EXEC [dbo].[ProductOnOrder]
				@ProductID = @ProductID,
				@LocalProductOnOrder = @ProductOnOrder OUTPUT, --
				@LocalErrorCode = @LocalErrorCode OUTPUT,
				@LocalMessage = @LocalMessage OUTPUT;

			SET @ProductOnOrder = ISNULL(@ProductOnOrder, 0);
			SET @QuantityToAllocate = @ProductAvailable + @ProductOnOrder;
			
			--4. QuantitytoAllocate is the sum of product already in the warehouse (ProductAvailable)  
			      --plus product on trucks on the way to our warehouse (ProductOnOrder) 
					SET @QuantityToAllocate = @ProductAvailable + @ProductOnOrder;
		END
			-- We now have the quantities we need in order to be able to allocate available product to orders asking for it
			--5. Use a cursor to allocate product to each open order with that product in one of its line items and which is in "On Order" or "No Stock" Status
		BEGIN 
			...
			END
			--Orders selected into the cursor are those in which the current product appears in the No Stock status or in the On Order Status
			DECLARE UpdateProducts CURSOR FAST_FORWARD FOR
				SELECT od.OrderDetailID, od.Quantity
				FROM OrderDetails od
				INNER JOIN Orders o ON o.OrderID = od.OrderID
				WHERE od.ProductID = @ProductID AND od.OrderDetailStatusID in (4, 5)
				ORDER BY o.OrderDate, o.OrderID;
			OPEN UpdateProducts;
			FETCH NEXT FROM UpdateProducts INTO @LocalOrderDetailID, @ThisOrderQuantity;

			WHILE @@FETCH_STATUS = 0
					BEGIN	
						--Update each order in turn in the cursor
						--We can Allocate when the amount available is equal to or greater than the amount on each order, in turn 
						--Continue until a) all available product has been allocated, or b) all open orders have been satisfied
						If @ThisOrderQuantity <= @ProductAvailable
							BEGIN
								Update OrderDetails
								SET OrderDetailStatusID = 1 -- Allocated
								WHERE OrderDetailID = @LocalOrderDetailID;
								--1. Reduce the remaining quantity available by the amount allocated to this order
								--2. Reduce the remaining quantity available to allocate by the amount allocated to this order
								SET @QuantityToAllocate = @QuantityToAllocate - @ThisOrderQuantity
								SET @ProductAvailable = @ProductAvailable - @ThisOrderQuantity; 
								--Note: Equivalent syntax could be implemented
								--SET @QuantityToAllocate -= @ThisOrderQuantity;
								--SET @ProductAvailable -= @ThisOrderQuantity;
							END
							--When the current order quantity is greater than the product available, and less than the product available + product on order on POs
							--1, Set this order status to On Order
						Else If @ThisOrderQuantity <= @QuantityToAllocate -- Remainder after allowing for allocated orders
							...
							END
						ELSE
							-- When we get to here, we are in a No Stock status, nothing in stock or on order.
							BEGIN
								Update OrderDetails
...
END
GO
/****** Object:  StoredProcedure [dbo].[AuditTriggers]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- NOTE: This bypasses auditing; exercise caution. Should be used in transactions
-- =============================================
...
END
GO
/****** Object:  StoredProcedure [dbo].[CompaniesFieldName]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CompanyContacts]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CompanyTypesList]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CRUDCompany]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
	...
	DECLARE 
	 ...
	 IF @CrudType = 1
		EXECUTE [dbo].[Z_AddCompany] 
			...
			, @Website = @Website
			, @Notes = @Notes
			, @StandardTaxStatusID = @StandardTaxStatusID
			, @LocalID = @LocalID OUTPUT
			, @ErrorCode = @LocalErrorCode OUTPUT
			, @Message = @LocalMessage OUTPUT;
	 ELSE
	 IF @CrudType = 2
		EXECUTE [dbo].[Z_SelectCompany] 
			  @CompanyID = @CompanyID
			, @CompanyTypeID = @CompanyTypeID
			, @StandardTaxStatusID = @StandardTaxStatusID
			, @StateAbbrev = @StateAbbrev
...
GO
/****** Object:  StoredProcedure [dbo].[CRUDEmployee]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CRUDMRU]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CRUDOrder]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CRUDOrderDetail]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
		...
		If @CRUDType= 1 
			BEGIN
				EXEC dbo.Z_AddOrderDetail 
					...
					@Discount = @Discount , 
					@UnitPrice = @UnitPrice, 
					@OrderDetailStatusID = 1, -- status defaults to new for new order details
...
END
GO
/****** Object:  StoredProcedure [dbo].[CRUDProduct]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CRUDProductVendors]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CRUDPurchaseOrder]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CRUDPurchaseOrderDetail]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CRUDStockTake]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CRUDSystemSettings]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CRUDUserSettings]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CustomErrorMessage]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[EmployeeOrders]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE PROCEDURE [dbo].[EmployeeOrders]
	...
	END
GO
/****** Object:  StoredProcedure [dbo].[ImportEmployeeImage]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[InvoiceOrders]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[InvoiceStatus]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[LineItemsAllocated]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[PODetails_AllPOs]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductAllocated]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductAvailable]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
/*===========================
NWPA Demo App - Not for Production Use
Author: George Hepworth
Create date: 03/17/2025
Stored Procedure: ProductAvailable
Description: Called by "AllocateInventory" to determine the Product Available on the last StockTake date
Notes:
  * Although we assume AddNewProductToStockTake has been run already; call here is defensive
=============================================
*/
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductBoughtAllTime]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductBoughtSinceLastStockTake]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Author:		 George Hepworth
Create date: 4/22/2025
Description: Get the Product Bought 
			 since last stocktake date 
=============================================
*/
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductCategoryList]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductLastStockTakeDateQOH]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Author: George Hepworth
Create date: 4/22/2025
Stored Procedure: ProductLastStockTakeDateQOH
Description: Called by "AllocateInventory" to determine the last previous stock take date for a product
			 and the Quantity on Hand for that product on that date
Create date: 4/24/2025
=============================================
*/
...
BEGIN	
	SET NOCOUNT ON;
	BEGIN TRY
		DECLARE @LocalLastStockTakeDate as Datetime,
				@LocalLastStockTakeQOH as int;
		SELECT @LocalLastStockTakeDate =Max([StockTakeDate]) 
		FROM [dbo].[StockTake]
		WHERE ProductID = @ProductID;
		...
		FROM [dbo].[StockTake]
		WHERE ProductID = @ProductID
		AND Cast(StockTakeDate as Date) = cast(@LocalLastStockTakeDate as date);
		Print @LocalLastStockTakeDate;
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductList]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductNoStock]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductOnOrder]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Create date: 4/22/2025
Stored Procedure: ProductAvailable
Description: Called by "AllocateInventory" to determine the Product on order at this time 
=============================================
*/
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductOrdersByProduct]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductReorderQuantity]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductsAllocated]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductsNotInPO]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductSoldAllTime]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductSoldSinceLastStockTake]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Author:		 George Hepworth
Create date: 4/22/2025
Description: Get the quantity of Product Sold since last stock take
=============================================
*/
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductStockTakesByProduct]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ProductVendorsByProduct]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[PurchaseOrderList]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[PurchaseOrdersByProduct]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ReceivePurchaseOrder]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Author:		 George Hepworth
Create date: 4/24/2025
Description: Receive a PO and Allocate Inventory for products received in that PO
Stored Procedure: ReceivePurchaseOrder
Description: Entry point to receive a purchase order and allocate inventory
Notes:
 * Uses cursor for clarity in demo; consider set-based logic for production
 * Assumes AddNewProductToStockTake has been run already; call is defensive
=================================================
...
BEGIN
	...
	BEGIN TRY
		...
		--Uses cursor for clarity in demo; consider set-based logic for production
		--Defensive programming -- Clean up any pre-existing cursor
		...
		DECLARE UpdatePODetails CURSOR FAST_FORWARD FOR
			SELECT PurchaseOrderDetailID, ProductID, Quantity
			FROM PurchaseOrderDetails
			WHERE PurchaseOrderID = @PurchaseOrderID; 

		OPEN UpdatePODetails;
		FETCH NEXT FROM UpdatePODetails INTO @PurchaseOrderDetailID, @ProductID, @ThisProductQuantity;

		WHILE @@FETCH_STATUS = 0
		BEGIN
			-- Call to AllocateInventory does the real work
		...
		SET @LocalID = @PurchaseOrderID;
		SET @LocalErrorCode = 0;
		SET @LocalMessage = 'Successfully allocated Purchase Order to all Orders for ' + CAST(@PurchaseOrderID AS VARCHAR);
	END TRY
	BEGIN CATCH
...
END
GO
/****** Object:  StoredProcedure [dbo].[SelectEmployeeforApprove]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SelectEmployeeforSubmit]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SelectEmployeesforList]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SelectOrderList]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SelectWelcome]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SSEErrorList]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[StatesList]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Statuses]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[StockLevelCheck]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[StockTakeList]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[TablesFieldNames]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[TaxStatusList]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[TitleList]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[UpdateEmployeePhoto]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[UpdateOrderStatus]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[UpdatePOStatus]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_AddCompany]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_AddEmployee]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_AddMRU]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_AddOrder]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_AddOrderDetail]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Z_AddPO]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_AddPODetail]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Z_AddProduct]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_AddProductVendor]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_AddStockTake]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_AddSystemSetting]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_AddUserSetting]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_DeleteCompany]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_DeleteEmployee]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_DeleteMRU]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_DeleteOrder]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_DeleteOrderDetail]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_DeletePO]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_DeletePODetail]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_DeleteProduct]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_DeleteProductVendor]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_DeleteStockTake]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_DeleteSystemSetting]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_DeleteUserSetting]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_SelectCompany]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_SelectEmployee]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_SelectMRU]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_SelectOrder]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_SelectOrderDetail]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Z_SelectPO]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_SelectPODetail]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_SelectProduct]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_SelectProductVendor]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_SelectStocktake]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_SelectSystemSetting]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_SelectUserSetting]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_UpdateCompany]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_UpdateEmployee]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_UpdateMRU]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_UpdateOrder]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_UpdateOrderDetail]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
--We have a business rule disallowing duplicating products in an order. 
--A product can be changed before the order is committed.
--A Check restraint on ProductID and OrderID raises an error if we try to add
--a new Order Detail or modify an existing Order Detail that violates the rule.
...
GO
/****** Object:  StoredProcedure [dbo].[Z_UpdatePO]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_UpdatePODetail]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Z_UpdateProduct]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Z_UpdateProductVendor]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_UpdateStockTake]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Z_UpdateSystemSetting]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Z_UpdateUserSetting]    Script Date: 8/2/2025 9:12:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_Contacts'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_Contacts'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane1', @value=N'[0E232FF0-B466-11cf-A24F-00AA00A3EFFF, 1.00]
Begin DesignProperties = 
   Begin PaneConfigurations = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Or = 1350
         Or = 1350
  ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_EmployeeOrders'
GO
...
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_EmployeeOrders'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=2 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_EmployeeOrders'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane1', @value=N'[0E232FF0-B466-11cf-A24F-00AA00A3EFFF, 1.00]
Begin DesignProperties = 
   Begin PaneConfigurations = 
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_employees'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane1', @value=N'[0E232FF0-B466-11cf-A24F-00AA00A3EFFF, 1.00]
Begin DesignProperties = 
   Begin PaneConfigurations = 
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane2', @value=N'    Alias = 4440
         Table = 1170
         Output = 720
         Append = 1400
         NewValue = 1170
...
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_OrderList'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=2 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_OrderList'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane1', @value=N'[0E232FF0-B466-11cf-A24F-00AA00A3EFFF, 1.00]
Begin DesignProperties = 
   Begin PaneConfigurations = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_PODetails_AllPOs'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_PODetails_AllPOs'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane1', @value=N'[0E232FF0-B466-11cf-A24F-00AA00A3EFFF, 1.00]
Begin DesignProperties = 
   Begin PaneConfigurations = 
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_UATest'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_UATest'
GO

USE [NWPADev]
GO
INSERT [dbo].[Titles] ([Title], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (N'', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Titles] ([Title], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (N'Mr.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Titles] ([Title], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (N'Mrs.', N'NWPADev_user', CAST(N'2025-03-15T08:38:51.000' AS DateTime), N'NWPADev_user', CAST(N'2025-03-15T08:45:11.000' AS DateTime))
GO
INSERT [dbo].[Titles] ([Title], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (N'Ms.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
...
Supervisor in training', NULL, N'NancyF.jpg', NULL, NULL, N'Admin@Northwind.com', N'Admin', CAST(N'2025-02-16T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-07-12T06:48:13.930' AS DateTime))
GO
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [EmailAddress], [JobTitle], [PrimaryPhone], [SecondaryPhone], [Title], [Notes], [EmployeeImagePA], [EmployeeImageName], [EmployeeImage], [SupervisorID], [WindowsUserName], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (2, N'Andrew', N'Cencini', N'Andrew@northwindtraders.com', N'Vice President, Sale', N'123-555-0101', N'123-999-6565', N'Mr.', N'Joined the company as a sales representative, was promoted to sales manager and was then named vice president of sales.', NULL, N'AndrewC.jpg', NULL, 1, N'Admin@Northwind.com', N'Admin', CAST(N'2025-02-16T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T15:54:10.223' AS DateTime))
GO
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [EmailAddress], [JobTitle], [PrimaryPhone], [SecondaryPhone], [Title], [Notes], [EmployeeImagePA], [EmployeeImageName], [EmployeeImage], [SupervisorID], [WindowsUserName], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (3, N'Jan', N'Kotas', N'jan@northwindtraders.com', N'Sales Representative', N'123-555-0102', NULL, N'Ms.', N'Was hired as a sales associate and was promoted to sales representative.', NULL, N'JanK.jpg', NULL, 2, NULL, N'Admin', CAST(N'2025-02-16T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-03-31T07:33:55.040' AS DateTime))
GO
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [EmailAddress], [JobTitle], [PrimaryPhone], [SecondaryPhone], [Title], [Notes], [EmployeeImagePA], [EmployeeImageName], [EmployeeImage], [SupervisorID], [WindowsUserName], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (4, N'Mariya', N'Sergienko', N'mariya@northwindtraders.com', N'Sales Representative', N'123-555-0103', NULL, NULL, NULL, NULL, N'MariyaS.jpg', NULL, NULL, NULL, N'Admin', CAST(N'2025-02-16T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-03-31T07:33:55.040' AS DateTime))
GO
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [EmailAddress], [JobTitle], [PrimaryPhone], [SecondaryPhone], [Title], [Notes], [EmployeeImagePA], [EmployeeImageName], [EmployeeImage], [SupervisorID], [WindowsUserName], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (5, N'Steven', N'Thorpe', N'steven@northwindtraders.com', N'Sales Manager', N'123-555-0104', NULL, NULL, N'Joined the company as a sales representative and was promoted to sales manager.  Fluent in French.', NULL, N'StevenT.jpg', NULL, 3, NULL, N'Admin', CAST(N'2025-02-16T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-03-31T07:33:55.040' AS DateTime))
GO
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [EmailAddress], [JobTitle], [PrimaryPhone], [SecondaryPhone], [Title], [Notes], [EmployeeImagePA], [EmployeeImageName], [EmployeeImage], [SupervisorID], [WindowsUserName], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (6, N'Michael', N'Neipper', N'michael@northwindtraders.com', N'Sales Representative', N'123-555-0105', NULL, NULL, N'Fluent in Japanese and can read and write French, Portuguese, and Spanish.', NULL, N'MichaelN.jpg', NULL, NULL, NULL, N'Admin', CAST(N'2025-02-16T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-03-31T07:33:55.040' AS DateTime))
GO
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [EmailAddress], [JobTitle], [PrimaryPhone], [SecondaryPhone], [Title], [Notes], [EmployeeImagePA], [EmployeeImageName], [EmployeeImage], [SupervisorID], [WindowsUserName], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (7, N'Robert', N'Zare', N'robert@northwindtraders.com', N'Sales Representative', N'123-555-0106', NULL, NULL, NULL, NULL, N'RobertZ.jpg', NULL, NULL, NULL, N'Admin', CAST(N'2025-02-16T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-03-31T07:33:55.040' AS DateTime))
GO
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [EmailAddress], [JobTitle], [PrimaryPhone], [SecondaryPhone], [Title], [Notes], [EmployeeImagePA], [EmployeeImageName], [EmployeeImage], [SupervisorID], [WindowsUserName], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (8, N'Laura', N'Giussani', N'laura@northwindtraders.com', N'Sales Coordinator', N'123-555-0107', NULL, N'Ms.', N'Reads and writes French.', NULL, N'LauraG.jpg', NULL, 2, N'Admin@Northwind.com', N'Admin', CAST(N'2025-02-16T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-04-01T16:24:09.153' AS DateTime))
GO
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [EmailAddress], [JobTitle], [PrimaryPhone], [SecondaryPhone], [Title], [Notes], [EmployeeImagePA], [EmployeeImageName], [EmployeeImage], [SupervisorID], [WindowsUserName], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (9, N'Anne', N'Hellung-Larsen', N'anne@northwindtraders.com', N'Sales Representative', N'123-555-0108', NULL, NULL, N'Fluent in French and German.', NULL, N'AnneH.jpg', NULL, 2, NULL, N'Admin', CAST(N'2025-02-16T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-03-31T07:33:55.040' AS DateTime))
GO
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [EmailAddress], [JobTitle], [PrimaryPhone], [SecondaryPhone], [Title], [Notes], [EmployeeImagePA], [EmployeeImageName], [EmployeeImage], [SupervisorID], [WindowsUserName], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (10, N'Internet', N'Sales', NULL, N'Internet Bot', NULL, NULL, NULL, N'Internet sales is not a human employee', NULL, NULL, NULL, 2, N'Admin@Northwind.com', N'Admin', CAST(N'2025-02-16T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-07-26T05:49:50.220' AS DateTime))
GO
INSERT [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [EmailAddress], [JobTitle], [PrimaryPhone], [SecondaryPhone], [Title], [Notes], [EmployeeImagePA], [EmployeeImageName], [EmployeeImage], [SupervisorID], [WindowsUserName], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (27, N'Wilmer', N'Ortega', N'WOR@NorthwinderTraders.com', N'Bubba', N'111-111-1111', N'222-222-3333', N'Mr.', N'New Bubba sells stuff!', NULL, NULL, NULL, 1, N'Admin@Northwind.com', N'NWPADev_user', CAST(N'2025-04-20T10:19:47.010' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T14:01:01.070' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[Employees] OFF
GO
SET IDENTITY_INSERT [dbo].[CompanyTypes] ON 
GO
INSERT [dbo].[CompanyTypes] ([CompanyTypeID], [CompanyType], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (1, N'Customer', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-03-15T06:24:49.000' AS DateTime))
GO
INSERT [dbo].[CompanyTypes] ([CompanyTypeID], [CompanyType], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (2, N'Shipper', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[CompanyTypes] ([CompanyTypeID], [CompanyType], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (3, N'Vendor', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[CompanyTypes] ([CompanyTypeID], [CompanyType], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (4, N'Northwind', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[CompanyTypes] OFF
GO
INSERT [dbo].[TaxStatus] ([TaxStatusID], [TaxStatus], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (0, N'Tax Exempt', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[TaxStatus] ([TaxStatusID], [TaxStatus], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (1, N'Taxable', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
...
GO
INSERT [dbo].[Companies] ([CompanyID], [CompanyName], [CompanyTypeID], [BusinessPhone], [Address], [City], [StateAbbrev], [Zip], [Website], [Notes], [StandardTaxStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (1, N'Adatum Corporation', 1, N'123-555-1212', N'123 Oak Street', N'Redmond', N'WA', N'90001', N'#http://www.adatum.com/#', N'<div><span style="color:#70ad47; font-size:large"><strong>This </strong></span><span style="font-size:large">is an <strong>RTF </strong></span><span style="color:#2e75b5; font-size:large"><strong>test</strong></span></div>', 1, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-04-20T06:04:28.933' AS DateTime))
GO
INSERT [dbo].[Companies] ([CompanyID], [CompanyName], [CompanyTypeID], [BusinessPhone], [Address], [City], [StateAbbrev], [Zip], [Website], [Notes], [StandardTaxStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (2, N'Adventure Works Cycles', 1, N'234-555-1212 x123', N'234 Elm Street', N'Tacoma', N'WA', N'90002-2222', NULL, NULL, 0, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-04-21T18:28:24.767' AS DateTime))
GO
INSERT [dbo].[Companies] ([CompanyID], [CompanyName], [CompanyTypeID], [BusinessPhone], [Address], [City], [StateAbbrev], [Zip], [Website], [Notes], [StandardTaxStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (3, N'Best For You Organics Company', 1, N'425-876-0535', N'345 Mesquite Lane', N'Mesa', N'AZ', N'90003', N'http://www.bestforyouorganics.com', NULL, 0, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-03-15T06:15:24.000' AS DateTime))
GO
INSERT [dbo].[Companies] ([CompanyID], [CompanyName], [CompanyTypeID], [BusinessPhone], [Address], [City], [StateAbbrev], [Zip], [Website], [Notes], [StandardTaxStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (4, N'Contoso, Inc.', 1, NULL, N'456 Queen Palm Avenue', N'Ft Lauderdale', N'FL', N'90004', N'http://www.contoso.com/', NULL, 0, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Companies] ([CompanyID], [CompanyName], [CompanyTypeID], [BusinessPhone], [Address], [City], [StateAbbrev], [Zip], [Website], [Notes], [StandardTaxStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (5, N'Woodgrove Bank', 1, N'505-555-1212 (cell)', N'567 Green Avenue', N'St. Louis', N'MO', N'90005', N'www.woodgrove.com', NULL, 1, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T13:30:40.523' AS DateTime))
GO
INSERT [dbo].[Companies] ([CompanyID], [CompanyName], [CompanyTypeID], [BusinessPhone], [Address], [City], [StateAbbrev], [Zip], [Website], [Notes], [StandardTaxStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (6, N'Wide World Importers', 1, N'600-555-1212', N'6001 Purple Street', N'Atlanta', N'GA', N'90006', NULL, NULL, 0, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Companies] ([CompanyID], [CompanyName], [CompanyTypeID], [BusinessPhone], [Address], [City], [StateAbbrev], [Zip], [Website], [Notes], [StandardTaxStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (7, N'Tailwind Traders', 1, N'711-555-1212', N'70 N Blue Water Lane', N'Richmond', N'VA', N'90007', NULL, NULL, 0, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Companies] ([CompanyID], [CompanyName], [CompanyTypeID], [BusinessPhone], [Address], [City], [StateAbbrev], [Zip], [Website], [Notes], [StandardTaxStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (8, N'Proseware, Inc.', 1, N'8012221212ext22022', N'801 Ironwood Rd', N'Manchester', N'NH', N'90008', NULL, NULL, 1, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Companies] ([CompanyID], [CompanyName], [CompanyTypeID], [BusinessPhone], [Address], [City], [StateAbbrev], [Zip], [Website], [Notes], [StandardTaxStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (9, N'Green Shipping Co', 2, N'800-555-1212', N'9000 Green Street', N'Green Bay', N'WI', N'90009', NULL, NULL, 0, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
...
GO
INSERT [dbo].[Companies] ([CompanyID], [CompanyName], [CompanyTypeID], [BusinessPhone], [Address], [City], [StateAbbrev], [Zip], [Website], [Notes], [StandardTaxStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (11, N'Yellow Vendor Co', 3, NULL, N'111 Yellow Brick Road', N'New York', N'NY', N'90011', NULL, NULL, 1, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Companies] ([CompanyID], [CompanyName], [CompanyTypeID], [BusinessPhone], [Address], [City], [StateAbbrev], [Zip], [Website], [Notes], [StandardTaxStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (12, N'Brown Vendor Co', 3, NULL, N'222 Brown Street', N'Brownsville', N'TX', N'78520', NULL, NULL, 1, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Companies] ([CompanyID], [CompanyName], [CompanyTypeID], [BusinessPhone], [Address], [City], [StateAbbrev], [Zip], [Website], [Notes], [StandardTaxStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (13, N'Northwind Traders', 4, NULL, N'One Portals Way', N'Twin Points', N'WA', N'12345', N'www.northwindtraders.com#http://www.northwindtraders.com/#', NULL, 0, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Companies] ([CompanyID], [CompanyName], [CompanyTypeID], [BusinessPhone], [Address], [City], [StateAbbrev], [Zip], [Website], [Notes], [StandardTaxStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (85, N'Brave Heart', 1, N'666-666-9898', N'123 S Main', N'Brisbane', N'MN', N'99999', N'www.Brave.org', N'<p>Sole Prop needs a break</p>', 0, N'NWPADev_user', CAST(N'2025-04-19T16:09:31.943' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T13:30:15.953' AS DateTime))
GO
INSERT [dbo].[Companies] ([CompanyID], [CompanyName], [CompanyTypeID], [BusinessPhone], [Address], [City], [StateAbbrev], [Zip], [Website], [Notes], [StandardTaxStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (101, N'Grover Park Consulting', 1, N'425-000-0000', N'5555 5th St S', N'Puyallup', N'WA', N'98300', N'www.gpcdata.com', N'most important', 1, N'NWPADev_user', CAST(N'2025-04-21T19:16:31.543' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T16:07:52.280' AS DateTime))
GO
INSERT [dbo].[Companies] ([CompanyID], [CompanyName], [CompanyTypeID], [BusinessPhone], [Address], [City], [StateAbbrev], [Zip], [Website], [Notes], [StandardTaxStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (107, N'Miracles', 1, N'333-333-6666', N'123', N'Puyallup', N'WA', N'99999', NULL, NULL, 0, N'NWPADev_user', CAST(N'2025-05-01T14:50:33.003' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[Companies] ([CompanyID], [CompanyName], [CompanyTypeID], [BusinessPhone], [Address], [City], [StateAbbrev], [Zip], [Website], [Notes], [StandardTaxStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (116, N'Northwest Candy Company', 1, N'425 555 0000', N'39090 SE 5th Street', N'Puyallup', N'WA', N'98374', NULL, N'<p>New as of May, 2025</p>', 1, N'NWPADev_user', CAST(N'2025-05-11T07:37:13.753' AS DateTime), NULL, NULL)
GO
SET IDENTITY_INSERT [dbo].[Companies] OFF
GO
SET IDENTITY_INSERT [dbo].[OrderDetailStatus] ON 
GO
INSERT [dbo].[OrderDetailStatus] ([OrderDetailStatusID], [OrderDetailStatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (1, N'Allocated', 40, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[OrderDetailStatus] ([OrderDetailStatusID], [OrderDetailStatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (2, N'Invoiced', 50, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[OrderDetailStatus] ([OrderDetailStatusID], [OrderDetailStatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (3, N'New', 10, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[OrderDetailStatus] ([OrderDetailStatusID], [OrderDetailStatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (4, N'No Stock', 20, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[OrderDetailStatus] ([OrderDetailStatusID], [OrderDetailStatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (5, N'On Order', 30, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[OrderDetailStatus] ([OrderDetailStatusID], [OrderDetailStatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (6, N'Shipped', 60, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[OrderDetailStatus] ([OrderDetailStatusID], [OrderDetailStatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (7, N'Lost in Transit', 70, N'NWPADev_user', CAST(N'2025-03-15T06:46:10.000' AS DateTime), N'NWPADev_user', CAST(N'2025-03-15T06:46:26.000' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[OrderDetailStatus] OFF
GO
SET IDENTITY_INSERT [dbo].[OrderStatus] ON 
GO
INSERT [dbo].[OrderStatus] ([OrderStatusID], [OrderStatusCode], [OrderStatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (1, N'CLO', N'Closed', 40, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[OrderStatus] ([OrderStatusID], [OrderStatusCode], [OrderStatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (2, N'INV', N'Invoiced', 20, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[OrderStatus] ([OrderStatusID], [OrderStatusCode], [OrderStatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (3, N'NEW', N'New', 10, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[OrderStatus] ([OrderStatusID], [OrderStatusCode], [OrderStatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (4, N'SHI', N'Shipped', 30, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[OrderStatus] ([OrderStatusID], [OrderStatusCode], [OrderStatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (5, N'PAY', N'Paid', 35, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[OrderStatus] OFF
GO
SET IDENTITY_INSERT [dbo].[Orders] ON 
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (176, 10, 2, CAST(N'2025-06-05T14:20:39.453' AS DateTime), CAST(N'2025-06-05T14:51:48.137' AS DateTime), CAST(N'2025-06-05T14:51:54.490' AS DateTime), 85, 40.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Check', CAST(N'2025-06-05T14:51:57.797' AS DateTime), NULL, 1, N'NWPADev_user', CAST(N'2025-06-05T13:53:47.680' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:52:09.720' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (177, 10, 2, CAST(N'2025-06-05T14:20:39.453' AS DateTime), CAST(N'2025-06-05T14:07:11.417' AS DateTime), CAST(N'2025-06-05T14:11:45.500' AS DateTime), NULL, 26.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', CAST(N'2025-06-05T14:14:46.483' AS DateTime), NULL, 1, N'NWPADev_user', CAST(N'2025-06-05T13:54:05.310' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:20:39.463' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (181, 10, 2, CAST(N'2025-06-05T21:46:34.780' AS DateTime), NULL, NULL, NULL, 0.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', NULL, NULL, 3, N'NWPADev_user', CAST(N'2025-06-05T21:46:34.790' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T11:07:34.717' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (185, 10, 2, CAST(N'2025-06-06T06:13:31.407' AS DateTime), CAST(N'2025-06-11T11:17:49.363' AS DateTime), CAST(N'2025-06-11T11:18:11.227' AS DateTime), 10, 60.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', CAST(N'2025-06-11T11:18:19.053' AS DateTime), NULL, 1, N'NWPADev_user', CAST(N'2025-06-06T06:13:31.420' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T11:18:23.883' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (189, 10, 2, CAST(N'2025-06-06T06:24:35.670' AS DateTime), NULL, NULL, 9, 0.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', NULL, NULL, 3, N'NWPADev_user', CAST(N'2025-06-06T06:24:35.670' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T12:10:22.727' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (192, 10, 2, CAST(N'2025-06-06T06:34:01.987' AS DateTime), CAST(N'2025-06-16T16:33:08.810' AS DateTime), CAST(N'2025-07-13T14:42:36.087' AS DateTime), 10, 10.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', CAST(N'2025-07-13T14:42:38.903' AS DateTime), NULL, 1, N'NWPADev_user', CAST(N'2025-06-06T06:34:02.000' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T14:42:41.280' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (199, 6, 4, CAST(N'2025-06-16T14:42:25.600' AS DateTime), CAST(N'2025-06-16T15:21:56.350' AS DateTime), CAST(N'2025-06-16T15:29:21.493' AS DateTime), 10, 12.5000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', CAST(N'2025-06-17T06:59:01.717' AS DateTime), NULL, 1, N'NWPADev_user', CAST(N'2025-06-16T14:42:25.613' AS DateTime), N'NWPADev_user', CAST(N'2025-06-17T06:59:09.180' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (200, 10, 101, CAST(N'2025-06-17T06:59:34.273' AS DateTime), CAST(N'2025-06-17T16:18:54.373' AS DateTime), NULL, 10, 22.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', NULL, NULL, 2, N'NWPADev_user', CAST(N'2025-06-17T06:59:34.273' AS DateTime), N'NWPADev_user', CAST(N'2025-06-17T16:18:54.373' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (201, 10, 2, CAST(N'2025-06-20T06:19:34.110' AS DateTime), CAST(N'2025-07-01T12:33:45.870' AS DateTime), CAST(N'2025-07-01T12:33:50.813' AS DateTime), 10, 56.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', CAST(N'2025-07-01T12:33:53.467' AS DateTime), NULL, 1, N'NWPADev_user', CAST(N'2025-06-20T06:19:34.123' AS DateTime), N'NWPADev_user', CAST(N'2025-07-01T12:33:56.130' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (202, 10, 101, CAST(N'2025-07-01T12:35:01.660' AS DateTime), CAST(N'2025-07-13T16:09:45.430' AS DateTime), NULL, 85, 0.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', NULL, NULL, 2, N'NWPADev_user', CAST(N'2025-07-01T12:35:01.663' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T16:09:45.430' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (203, 10, 1, CAST(N'2025-07-04T05:01:15.500' AS DateTime), CAST(N'2025-07-04T05:35:38.443' AS DateTime), NULL, 10, 15.0000, CAST(0.085 AS Decimal(6, 3)), 1, N'Cash', NULL, NULL, 2, N'NWPADev_user', CAST(N'2025-07-04T05:01:15.510' AS DateTime), N'NWPADev_user', CAST(N'2025-07-04T05:35:38.443' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (204, 10, 101, CAST(N'2025-07-04T05:37:37.403' AS DateTime), CAST(N'2025-07-13T16:34:37.590' AS DateTime), CAST(N'2025-07-13T16:34:49.103' AS DateTime), NULL, 0.0000, CAST(0.085 AS Decimal(6, 3)), 1, N'Cash', NULL, NULL, 4, N'NWPADev_user', CAST(N'2025-07-04T05:37:37.403' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T16:34:49.107' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (205, 10, 101, CAST(N'2025-07-08T16:09:23.223' AS DateTime), CAST(N'2025-07-08T17:09:23.223' AS DateTime), CAST(N'2025-07-09T04:09:23.223' AS DateTime), 10, 150.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', CAST(N'2025-07-09T17:09:23.223' AS DateTime), N'Shipped early. Let customer know.', 1, N'NWPADev_user', CAST(N'2025-07-05T07:58:12.523' AS DateTime), N'NWPADev_user', CAST(N'2025-07-31T12:10:56.733' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (206, 10, 101, CAST(N'2025-07-07T10:07:02.583' AS DateTime), CAST(N'2025-07-07T10:51:43.590' AS DateTime), CAST(N'2025-07-07T10:52:56.557' AS DateTime), 9, 40.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', CAST(N'2025-07-07T10:53:00.453' AS DateTime), NULL, 1, N'NWPADev_user', CAST(N'2025-07-07T10:07:02.597' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T10:53:03.990' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (207, 10, 3, CAST(N'2025-07-07T15:54:15.780' AS DateTime), CAST(N'2025-07-07T15:55:06.450' AS DateTime), CAST(N'2025-07-07T15:55:30.020' AS DateTime), 10, 48.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', CAST(N'2025-07-07T15:55:40.173' AS DateTime), NULL, 1, N'NWPADev_user', CAST(N'2025-07-07T15:54:15.790' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T15:55:43.860' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (208, 10, 6, CAST(N'2025-07-07T15:56:28.467' AS DateTime), CAST(N'2025-07-07T15:57:20.940' AS DateTime), CAST(N'2025-07-07T15:57:38.770' AS DateTime), NULL, 40.0000, CAST(0.085 AS Decimal(6, 3)), 1, N'Cash', CAST(N'2025-07-07T15:57:42.713' AS DateTime), NULL, 1, N'NWPADev_user', CAST(N'2025-07-07T15:56:28.467' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T15:57:50.660' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (209, 10, 101, CAST(N'2025-07-09T12:20:29.660' AS DateTime), CAST(N'2025-07-09T12:27:38.360' AS DateTime), CAST(N'2025-07-09T12:28:27.640' AS DateTime), 10, 60.0000, CAST(0.085 AS Decimal(6, 3)), 1, N'Cash', CAST(N'2025-07-09T12:28:32.987' AS DateTime), NULL, 1, N'NWPADev_user', CAST(N'2025-07-09T12:20:29.670' AS DateTime), N'NWPADev_user', CAST(N'2025-07-09T12:28:35.383' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (210, 10, 4, CAST(N'2025-07-10T13:52:20.080' AS DateTime), NULL, NULL, NULL, 0.0000, CAST(0.000 AS Decimal(6, 3)), 0, N'Cash', NULL, NULL, 3, N'NWPADev_user', CAST(N'2025-07-10T13:52:20.093' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (211, 10, 85, CAST(N'2025-07-10T13:53:23.990' AS DateTime), CAST(N'2025-07-27T15:50:54.190' AS DateTime), CAST(N'2025-07-27T15:51:04.513' AS DateTime), 10, 415.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', CAST(N'2025-07-27T15:51:06.897' AS DateTime), NULL, 1, N'NWPADev_user', CAST(N'2025-07-10T13:53:23.990' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:51:08.823' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (212, 10, 3, CAST(N'2025-07-10T14:04:10.723' AS DateTime), CAST(N'2025-07-12T06:06:05.280' AS DateTime), NULL, 10, 20.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', NULL, NULL, 2, N'NWPADev_user', CAST(N'2025-07-10T14:04:10.727' AS DateTime), N'NWPADev_user', CAST(N'2025-07-12T06:06:05.280' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (213, 10, 6, CAST(N'2025-07-12T06:16:41.847' AS DateTime), CAST(N'2025-07-12T06:18:36.230' AS DateTime), CAST(N'2025-07-13T16:32:55.413' AS DateTime), 10, 10.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', CAST(N'2025-07-13T16:33:03.037' AS DateTime), NULL, 1, N'NWPADev_user', CAST(N'2025-07-12T06:16:41.850' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T16:33:14.820' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (214, 10, 3, CAST(N'2025-07-27T15:29:27.017' AS DateTime), CAST(N'2025-07-27T15:31:10.593' AS DateTime), CAST(N'2025-07-27T15:31:26.180' AS DateTime), 10, 20.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', CAST(N'2025-07-27T15:31:29.167' AS DateTime), NULL, 1, N'NWPADev_user', CAST(N'2025-07-27T15:29:27.030' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:31:32.370' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [EmployeeID], [CustomerID], [OrderDate], [InvoiceDate], [ShippedDate], [ShipperID], [ShippingFee], [TaxRate], [TaxStatusID], [PaymentMethod], [PaidDate], [Notes], [OrderStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (215, 10, 2, CAST(N'2025-07-27T16:03:23.933' AS DateTime), NULL, NULL, NULL, 25.0000, CAST(0.085 AS Decimal(6, 3)), 0, N'Cash', NULL, NULL, 3, N'NWPADev_user', CAST(N'2025-07-27T16:03:23.940' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T16:04:31.000' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[Orders] OFF
GO
SET IDENTITY_INSERT [dbo].[ProductCategories] ON 
GO
INSERT [dbo].[ProductCategories] ([ProductCategoryID], [ProductCategoryName], [ProductCategoryCode], [ProductCategoryDesc], [ProductCategoryImageName], [ProductCategoryImage], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (1, N'Baked Goods & Mixes', N'BAK', N'Baked Goods and Baking Mixes', N'Baked3.jpg', NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductCategories] ([ProductCategoryID], [ProductCategoryName], [ProductCategoryCode], [ProductCategoryDesc], [ProductCategoryImageName], [ProductCategoryImage], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (2, N'Beverages', N'BEV', N'Coffee, Soda, Water, Juices and Beers', N'Beverage3.jpg', NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductCategories] ([ProductCategoryID], [ProductCategoryName], [ProductCategoryCode], [ProductCategoryDesc], [ProductCategoryImageName], [ProductCategoryImage], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (3, N'Candy', N'CDY', N'Chocolate, Hard Candy and Mints', N'Candy3.jpg', NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductCategories] ([ProductCategoryID], [ProductCategoryName], [ProductCategoryCode], [ProductCategoryDesc], [ProductCategoryImageName], [ProductCategoryImage], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (4, N'Canned Fruit & Vegetables', N'CFV', N'Fruits and Vegetables in Cans and Jars', N'Canned Fruit.jpg', NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductCategories] ([ProductCategoryID], [ProductCategoryName], [ProductCategoryCode], [ProductCategoryDesc], [ProductCategoryImageName], [ProductCategoryImage], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (5, N'Canned Meat', N'CM', N'Tinned Fish, Beef and Pork', N'Canned Meat2.jpg', NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductCategories] ([ProductCategoryID], [ProductCategoryName], [ProductCategoryCode], [ProductCategoryDesc], [ProductCategoryImageName], [ProductCategoryImage], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (6, N'Cereal', N'CER', N'Oatmeal, Granola and Boxed Cereals', N'Cereal2.jpg', NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductCategories] ([ProductCategoryID], [ProductCategoryName], [ProductCategoryCode], [ProductCategoryDesc], [ProductCategoryImageName], [ProductCategoryImage], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (7, N'Chips, Snacks', N'SNK', N'Chips, Pretzels, Popcorn and Cheese Puffs', N'Chips3.jpg', NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductCategories] ([ProductCategoryID], [ProductCategoryName], [ProductCategoryCode], [ProductCategoryDesc], [ProductCategoryImageName], [ProductCategoryImage], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (8, N'Condiments', N'CON', N'Whole and Ground Spices, Herbs and Bottled Sauces', N'Condiment3.jpg', NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductCategories] ([ProductCategoryID], [ProductCategoryName], [ProductCategoryCode], [ProductCategoryDesc], [ProductCategoryImageName], [ProductCategoryImage], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (9, N'Dairy Products', N'DAI', N'Milk and Cheese from Satisfied Cows', N'Dairy.jpg', NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductCategories] ([ProductCategoryID], [ProductCategoryName], [ProductCategoryCode], [ProductCategoryDesc], [ProductCategoryImageName], [ProductCategoryImage], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (10, N'Dried Fruit & Nuts', N'DRI', N'Raw and Roasted Nuts, Seeds and Dehydrated Fruits', N'Dried Fruit3.jpg', NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductCategories] ([ProductCategoryID], [ProductCategoryName], [ProductCategoryCode], [ProductCategoryDesc], [ProductCategoryImageName], [ProductCategoryImage], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (11, N'Grains', N'GRA', N'Rice, Whole Wheat and Oats', N'Grains.jpg', NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductCategories] ([ProductCategoryID], [ProductCategoryName], [ProductCategoryCode], [ProductCategoryDesc], [ProductCategoryImageName], [ProductCategoryImage], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (12, N'Jams, Preserves', N'JAM', N'Preserved Fruit in Jars', N'Jam2.jpg', NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductCategories] ([ProductCategoryID], [ProductCategoryName], [ProductCategoryCode], [ProductCategoryDesc], [ProductCategoryImageName], [ProductCategoryImage], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (13, N'Oil', N'OIL', N'Cooking and Salad Oils', N'Oil.jpg', NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductCategories] ([ProductCategoryID], [ProductCategoryName], [ProductCategoryCode], [ProductCategoryDesc], [ProductCategoryImageName], [ProductCategoryImage], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (14, N'Pasta', N'PAS', N'Dried Wheat and Rice Pasta in Various Shapes and Varieties', N'Pasta3.jpg', NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductCategories] ([ProductCategoryID], [ProductCategoryName], [ProductCategoryCode], [ProductCategoryDesc], [ProductCategoryImageName], [ProductCategoryImage], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (15, N'Sauces', N'SAU', N'Tomato Sauces, Gravies and Hot Sauce', N'Sauce.jpg', NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductCategories] ([ProductCategoryID], [ProductCategoryName], [ProductCategoryCode], [ProductCategoryDesc], [ProductCategoryImageName], [ProductCategoryImage], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (16, N'Soups', N'SOU', N'Canned Soups, Chowders and Bisques', N'Soup.jpg', NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[ProductCategories] OFF
GO
SET IDENTITY_INSERT [dbo].[Products] ON 
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (1, N'NWTDRI- 74', N'Almonds', N'<div>Premium almonds from California''s Central Valley</div>', 7.5000, 10.0000, 30, 20, N'5 kg pkg.', 0, 5, 10, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (2, N'NWTBEV-2', N'Beer', N'<p>Belgian-style: a flavorful, balanced beer with characteristics of hops, malt and fruity yeast</p>', 10.5000, 14.0000, 90, 160, N'24 - 12 oz bottles', 0, 160, 2, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-07-15T05:57:26.753' AS DateTime))
GO
...
color="#6F3198"> </font>alternative topping for toast, pancakes and waffles</div>', 18.7500, 25.0000, 130, 100, N'12 - 8 oz jars', 0, 25, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-04-07T14:41:52.760' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (4, N'NWTBAK-4', N'Brownie Mix', N'<p>Rich and fudgy, for a dense, chewy brownie with fudge topping</p>', 9.0000, 12.4900, 30, 20, N'3 boxes', 0, 5, 1, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T14:38:20.783' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (5, N'NWTCON- 4', N'Cajun Seasoning', N'<div>Adds <font face=Forte color="#C55A11">zingy </font>new taste to meat, seafood, vegetables, eggs and more</div>', 16.5000, 22.0000, 60, 40, N'48 - 6 oz jars', 0, 10, 8, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (6, N'NWTBAK-6', N'Cake Mix', NULL, 10.5000, 15.9900, 30, 20, N'4 boxes', 0, 5, 1, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-07-14T13:13:45.150' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (7, N'NWTBEV- 1', N'Chai', N'<div><font face="Monotype Corsiva" color="#0C0C0C"><strong><em>Black tea</em></strong></font><em> </em>with a blend of cardamom, ginger, cloves and cinnamon</div>', 13.5000, 18.0000, 60, 40, N'10 boxes x 20 bags', 0, 10, 2, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
...
face="Bauhaus 93"> </font>hand-picked at their peak</div>', 1.0000, 2.0000, 60, 40, N'15.25 OZ', 0, 40, 4, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-06-01T09:14:52.240' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (9, N'NWTSOU- 99', N'Chicken Soup', N'<div>To warm the soul. Rich broth chock-full of tender chicken, fresh diced vegetables and hearty egg noodles</div>', 1.0000, 1.9500, 260, 200, N'1', 0, 90, 16, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (10, N'NWTCDY-10', N'Chocolate', N'<div>Smooth and satisfying, 72% <font face=Broadway color="#7A4E2B">cacao </font>for an antioxidant boost</div>', 9.5600, 12.7500, 130, 100, N'10 pkgs', 0, 25, 3, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-06-30T14:22:19.153' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (11, N'NWTBAK-11', N'Chocolate Biscuits Mix', N'<div>A flaky, buttery, <font face="Lucida Handwriting" color="#7A4E2B"><strong>chocolatey </strong></font>twist on traditional biscuits</div>', 6.9000, 9.2000, 30, 20, N'10 boxes x 12 pieces', 0, 5, 1, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-06-30T14:54:38.543' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (12, N'NWTSOU- 41', N'Clam Chowder', N'<div>New England style with a creamy base, with generous portions of clams and bacon</div>', 7.2375, 9.6500, 60, 40, N'12 - 12 oz cans', 0, 10, 16, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (13, N'NWTBEV-13', N'Coffee', NULL, 34.5000, 46.0000, 130, 100, N'16 - 500 g tins', 0, 25, 2, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-07-14T15:51:31.743' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (14, N'NWTCFV-14', N'Corn', N'<div>Delicious, tender tri-color sweet corn on the cob</div>', 1.0000, 1.2000, 80, 50, N'14.5 OZ', 0, 40, 4, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-06-30T14:25:39.143' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (15, N'NWTCM- 40', N'Crab Meat', N'<div>Authentic Maryland Blue crab meat, packed by hand</div>', 13.8000, 18.4000, 160, 120, N'24 - 4 oz tins', 0, 30, 5, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (16, N'NWTSAU- 8', N'Curry Sauce', N'<div>Thai style red curry sauce is a zesty blend of red chili puree, coconut milk, onions, garlic and ginger</div>', 30.0000, 40.0000, 60, 40, N'12 - 12 oz jars', 0, 10, 15, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (17, N'NWTDRI-17', N'Dried Apples', NULL, 39.7500, 53.0000, 60, 40, N'50 - 300 g pkgs.', 0, 10, 10, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-07-09T12:06:35.813' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (18, N'NWTDRI- 7', N'Dried Pears', N'<div>A sweet treat for hikers and snackers</div>', 22.5000, 30.0000, 60, 40, N'12 - 1 lb pkgs.', 0, 10, 10, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (19, N'NWTDRI- 80', N'Dried Plums', N'<div>Dense, sweet <font face="Curlz MT" size=3 color="#6F3198"><strong>dried plums</strong></font>: the perfect snack for people on the go</div>', 3.0000, 3.5000, 100, 75, N'1 lb bag', 0, 25, 10, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (20, N'NWTCFV-20', N'Fruit Cocktail', NULL, 29.2500, 39.0000, 60, 40, N'15.25 OZ cans', 0, 10, 4, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-07-01T12:18:22.220' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (21, N'NWTPAS- 56', N'Gnocchi', N'<div>Traditional Italian potato dumplings, fully-cooked; ready to heat and eat</div>', 28.5000, 38.0000, 160, 120, N'24 - 250 g pkgs.', 0, 30, 14, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (22, N'NWTCER- 82', N'Granola', N'<div>A super <font face="Snap ITC" size=3 color="#2F5496">crunchy </font>treat: Oats loaded with almonds, walnuts, hazelnuts, raisins, coconut and dried cranberry</div>', 2.0000, 4.0000, 130, 100, NULL, 0, 50, 6, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (23, N'NWTCFV-23', N'Green Beans', N'<div>Whole fresh <font color="#538135"><strong>green </strong></font>beans picked in their prime</div>', 1.0000, 1.2000, 60, 40, N'14.5 OZ', 0, 40, 4, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-06-01T09:38:28.663' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (24, N'NWTBEV- 81', N'Green Tea', N'<div>Authentic <font color="#538135"><strong>green tea</strong></font> leaves, dried quickly after harvest to preserve their vibrant color and naturally occurring antioxidants</div>', 2.0000, 2.9900, 170, 125, N'20 bags per box', 0, 25, 2, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
...
size=4> </font>Adds tastebud-searing warmth to any dish</div>', 15.7875, 21.0500, 60, 40, N'32 - 8 oz bottles', 0, 10, 15, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (26, N'NWTGRA- 52', N'Long Grain Rice', N'<div>Premium white Basmati</div>', 5.2500, 7.0000, 130, 100, N'16 - 2 kg boxes', 0, 25, 11, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (27, N'NWTDAI- 72', N'Mozzarella', N'<div>Fresh, mild and cheesy; a staple of Italian cuisine</div>', 26.1000, 34.8000, 60, 40, N'24 - 200 g pkgs.', 0, 10, 9, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (28, N'NWTCON- 77', N'Mustard', N'<div>Stone-ground dijon-style prepared mustard</div>', 9.7500, 13.0000, 90, 60, N'12 boxes', 0, 15, 8, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (29, N'NWTOIL- 5', N'Olive Oil', N'<div>Extra virgin for smooth taste and versatility</div>', 16.0125, 21.3500, 60, 40, N'36 boxes', 0, 10, 13, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (30, N'NWTCFV-30', N'Peaches', N'<div>Delicious, juicy freestone peaches suitable for canning, baking and snacking</div>', 1.0000, 1.5000, 60, 40, N'15.25 OZ', 0, 40, 4, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-06-01T09:43:29.650' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (31, N'NWTCFV-31', N'Pears', N'<div>Organic <font face="Berlin Sans FB" color="#BA1419">red D''Anjou pears</font>, ripened to pear-fection</div>', 1.0000, 1.3000, 60, 40, N'15.25 OZ', 0, 48, 4, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-06-01T09:42:06.260' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (32, N'NWTCFV-32', N'Peas', N'<div>Baby <font face="Showcard Gothic" color="#538135"><strong>green peas</strong> </font>in the pod, ready for shucking</div>', 1.0000, 1.5000, 60, 40, N'14.5 OZ', 0, 48, 4, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-06-01T09:44:05.723' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (33, N'NWTCFV-33', N'Pineapple', N'<div>Fresh from Hawaii: ripe, succulent whole fruits</div>', 1.0000, 1.8000, 60, 40, N'15.25 OZ', 0, 48, 4, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-06-01T09:44:21.033' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (34, N'NWTSNK- 83', N'Potato Chips', N'<div>Kettle-cooked crispy snackers</div>', 0.5000, 1.8000, 70, 50, NULL, 0, 75, 7, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (35, N'NWTPAS-35', N'Ravioli', N'<div>Tender pasta envelopes filled with ricotta cheese and spinach</div>', 14.6300, 19.5000, 110, 80, N'24 - 250 g pkgs.', 0, 20, 14, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T13:17:31.233' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (36, N'NWTBAK-36', N'Scones', N'<div>The perfect accompaniment to coffee or proper tea</div>', 7.5000, 10.0000, 30, 20, N'24 pkgs. x 4 pieces', 0, 5, 1, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-07-29T15:26:31.073' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (37, N'NWTCM-37', N'Smoked Salmon', N'<div>From the Pacific Northwest''s pristine icy cold waters and hardwood-smoked </div>', 2.0000, 4.0000, 70, 50, N'5 oz', 0, 25, 5, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-06-01T09:45:01.487' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (38, N'NWTCON- 3', N'Syrup', N'<div>Pure cane syrup</div>', 7.5000, 10.0000, 130, 100, N'12 - 550 ml bottles', 0, 25, 8, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (39, N'NWTBEV-39', N'Tea', N'<div>Robust<font color="#0C0C0C"><strong> </strong></font><font
face="Kristen ITC" color="#0C0C0C"><strong>black tea leaves</strong></font> have rich flavor, dark color, and a smooth finish</div>', 2.0000, 4.0000, 70, 50, N'100 count per box', 0, 50, 2, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-06-30T14:11:57.987' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (40, N'NWTSAU- 66', N'Tomato Sauce', N'<div>Delicately seasoned with salt, pepper and herbs</div>', 12.7500, 17.0000, 110, 80, N'24 - 8 oz jars', 0, 20, 15, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (41, N'NWTCM-41', N'Tuna Fish', N'<div>Wild-caught solid-white albacore tuna packed in water</div>', 0.5000, 2.0000, 70, 50, N'5 oz', 0, 60, 5, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'NWPADev_user', CAST(N'2025-06-01T09:45:44.077' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (42, N'NWTSOU- 98', N'Vegetable Soup', N'<div>Farm-fresh diced vegetable medley in a rich vegetable broth</div>', 1.0000, 1.8900, 260, 200, N'1', 0, NULL, 16, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (43, N'NWTDRI- 14', N'Walnuts', N'<div>Shelled, energy-dense and loaded with polyunsaturated &quot;good&quot; fats. Perfect baking and snacking</div>', 17.4375, 23.2500, 60, 40, N'40 - 100 g pkgs.', 0, 10, 10, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (44, N'NWTCDY-44', N'Grampa''s Gummies', N'<p>Surprise your fiends and family with<span style="color:#27ae60"><em> test products </em></span><em>based on your favorite cartoon characters.</em></p>', 12.0000, 24.0000, 25, 30, N'24 packets per box', 0, 45, 3, N'NWPADev_user', CAST(N'2025-03-17T06:27:32.473' AS DateTime), N'NWPADev_user', CAST(N'2025-05-03T13:50:07.873' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (47, N'NWTBAK-47', N'Multi-Grain Bun', NULL, 2.6500, 4.9900, 60, 40, N'40', 0, 40, 1, N'NWPADev_user', CAST(N'2025-04-21T10:09:44.833' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T09:43:14.097' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (49, N'NWTCM-49', N'Chili Dogs and Cheese', N'<p>Delicious and wholesome</p>', 16.0000, 32.5000, 60, 60, N'60', 0, 60, 5, N'NWPADev_user', CAST(N'2025-04-22T07:38:21.857' AS DateTime), N'NWPADev_user', CAST(N'2025-04-27T09:29:38.820' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (56, N'NWTCER-56', N'Golden Globes', N'Golden gloves of goodness. Real Chocolate, Real Peanuts, Real Good', 12.0000, 12.0000, 12, 12, N'12', 0, 60, 6, N'NWPADev_user', CAST(N'2025-04-22T08:28:46.950' AS DateTime), N'NWPADev_user', CAST(N'2025-05-03T13:35:41.713' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (59, N'NWTCM-59', N'Chili con Pollo', NULL, 1.0000, 2.9500, 60, 60, N'60', 0, 60, 5, N'NWPADev_user', CAST(N'2025-04-22T09:35:39.753' AS DateTime), N'NWPADev_user', CAST(N'2025-04-22T09:35:39.763' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (60, N'NWTCDY-60', N'Great Gobs of Fire', N'<p>Fiery <span style="color:#c0392b">cinnamon </span>goodness for the adventurous candy-lover.</p>', 9.0000, 18.0000, 50, 80, N'80', 0, 50, 3, N'NWPADev_user', CAST(N'2025-05-11T07:34:30.880' AS DateTime), N'NWPADev_user', CAST(N'2025-07-15T05:57:43.863' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (61, N'NWTJAM-61', N'Thank Heavens for Honey', N'<p>The most <span style="background-color:#f39c12">bee-</span>utiful honey available.</p>', 18.0000, 36.0000, 40, 60, N'60', 0, 36, 12, N'NWPADev_user', CAST(N'2025-06-03T17:11:28.697' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (64, N'NWTCDY-64', N'Goody Gum Drops', N'<p>Every drop is a burst of flavor delight. <span style="color:#c0392b">Strawberry</span>, <span style="color:#f39c12">Orange </span>and <span style="color:#8e44ad">Grape</span>.</p>', 2.5000, 6.7500, 100, 120, N'1', 0, 25, 3, N'NWPADev_user', CAST(N'2025-06-20T11:02:52.290' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T09:20:21.750' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (66, N'NWTPAS-66', N'Shell Macaroni', N'<p>Only first quality ingredients ensure a wholesome, tasty treat for your family</p>', 9.0000, 6.0000, 30, 30, N'30', 0, 30, 14, N'NWPADev_user', CAST(N'2025-06-29T11:01:52.220' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (71, N'NWTJAM-71', N'Chokecherry Jelly', N'<p>Exquisite taste. Unique color. A taste experience only available for a short time each season. Hand-crafted in small batches just for Northwind''s discriminating customers.</p>', 36.0000, 54.0000, 30, 30, N'30', 0, 30, 12, N'NWPADev_user', CAST(N'2025-06-29T11:26:14.207' AS DateTime), N'NWPADev_user', CAST(N'2025-07-01T13:39:07.747' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (73, N'NWTCM-73', N'Shredded Brisket', N'<p><strong>Prime </strong>Brisket, slow-roasted to a golden perfection.&nbsp;Your guests will toast your good taste. So pair this one with a wine from our wine list.</p>', 90.0000, 60.0000, 60, 90, N' 12 8 ounce cans', 0, 45, 5, N'NWPADev_user', CAST(N'2025-06-29T12:23:23.253' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T12:44:39.347' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (74, N'NWTBAK-74', N'Maple Bars', N'<p>Wake up to the nostalgic taste of Vermont Maple Sugar. Relax with the favorite hot beverage and savor the magic of our Maple Bars</p>', 2.9900, 6.9900, 50, 50, N'50', 0, 25, 1, N'NWPADev_user', CAST(N'2025-07-07T09:19:52.180' AS DateTime), N'NWPADev_user', CAST(N'2025-07-14T13:39:01.347' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (75, N'NWTDAI-75', N'Cheddar Bites', N'<p>Healthier snacking for everyone</p>', 36.0000, 48.0000, 90, 90, N'90', 0, 100, 9, N'NWPADev_user', CAST(N'2025-07-07T11:49:41.547' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T11:55:13.313' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (76, N'NWTDRI-76', N'Banana Chips', N'<p>Freeze dried at the peak of ripeness and shipped directly from the tropics to your door.</p>', 20.0000, 36.0000, 60, 60, N'60', 0, 45, 10, N'NWPADev_user', CAST(N'2025-07-07T12:30:52.990' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (77, N'NWTDRI-77', N'Betty Goat Gruff Cheese', NULL, 60.0000, 45.0000, 60, 60, N'60', 0, 60, 10, N'NWPADev_user', CAST(N'2025-07-07T12:43:31.010' AS DateTime), N'NWPADev_user', CAST(N'2025-07-12T06:57:38.870' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (78, N'NWTJAM-78', N'Golden Grape Jelly', N'<p>Grape Jelly like you''ve never tasted it before.</p>', 30.0000, 48.0000, 60, 60, N'60', 0, 60, 12, N'NWPADev_user', CAST(N'2025-07-07T12:49:21.077' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (80, N'NWTCM-80', N'Glazed Ham', N'<p>Slow cooked to perfection</p>', 18.0000, 35.0000, 60, 60, N'60 oz cans', 0, 9, 5, N'NWPADev_user', CAST(N'2025-07-07T12:55:16.683' AS DateTime), N'NWPADev_user', CAST(N'2025-07-15T06:49:12.317' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (81, N'NWTCDY-81', N'Swirly Bits in Chocolate', NULL, 22.0000, 36.0000, 60, 90, N'18 3 ounce pouchs', 0, 90, 3, N'NWPADev_user', CAST(N'2025-07-07T13:01:41.677' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T15:47:26.737' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (82, N'NWTCFV-82', N'Nectarines', N'<p>Picked at the peak of flavor. Nectarines are the fruit of the gods.</p>', 30.0000, 48.0000, 90, 90, N'90', 0, 90, 4, N'NWPADev_user', CAST(N'2025-07-07T15:49:38.103' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (83, N'NWTSNK-83', N'Carmel Popping Corn', N'<p>Firm and full-sized kernels every time</p>', 4.0000, 6.0000, 60, 60, N'60', 0, 25, 7, N'NWPADev_user', CAST(N'2025-07-09T12:17:13.450' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (84, N'NWTDRI-84', N'Dried Mango Slices in Ginger', N'<p>You''ve never experienced anything like the exotic taste of mango marinated in ginger and sun-dried.</p>', 36.0000, 48.0000, 60, 90, N'90', 0, 30, 10, N'NWPADev_user', CAST(N'2025-07-27T15:09:51.470' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:29:01.487' AS DateTime))
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (85, N'NWTCDY-85', N'Purple Slime', N'<p>Kids love this one.</p>', 12.0000, 18.0000, 60, 90, N'90', 0, 45, 3, N'NWPADev_user', CAST(N'2025-07-27T15:42:07.923' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[Products] ([ProductID], [ProductCode], [ProductName], [ProductDescription], [StandardUnitCost], [UnitPrice], [ReorderLevel], [TargetLevel], [QuantityPerUnit], [Discontinued], [MinimumReorderQuantity], [ProductCategoryID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (86, N'NWTCFV-86', N'Mandarine Oranges', N'<p>No added sugar</p>', 24.0000, 36.0000, 90, 120, N'120', 0, 80, 4, N'NWPADev_user', CAST(N'2025-07-27T15:47:20.580' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:47:33.790' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[Products] OFF
GO
SET IDENTITY_INSERT [dbo].[OrderDetails] ON 
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (1, 177, 4, 10, 12.4900, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-06-05T13:55:20.293' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (2, 177, 13, 25, 46.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-06-05T14:01:41.427' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (3, 177, 37, 25, 4.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-06-05T14:04:18.323' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (4, 177, 34, 5, 1.8000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-06-05T14:06:47.883' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (5, 176, 2, 30, 14.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-06-05T14:51:26.483' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (6, 185, 4, 5, 12.4900, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-06-11T11:15:27.507' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (7, 185, 13, 20, 46.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-06-11T11:15:44.603' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (8, 199, 24, 25, 2.9900, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-06-16T14:42:36.897' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (9, 189, 39, 20, 4.0000, CAST(0.000 AS Decimal(6, 3)), 1, N'NWPADev_user', CAST(N'2025-06-16T15:15:27.900' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (10, 192, 13, 25, 46.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-06-16T16:31:24.097' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (11, 200, 8, 20, 2.0000, CAST(0.000 AS Decimal(6, 3)), 2, N'NWPADev_user', CAST(N'2025-06-17T07:01:10.450' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:32:50.490' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (14, 200, 7, 20, 18.0000, CAST(0.000 AS Decimal(6, 3)), 2, N'NWPADev_user', CAST(N'2025-06-17T11:27:10.813' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:32:50.490' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (18, 200, 12, 10, 9.6500, CAST(0.000 AS Decimal(6, 3)), 2, N'NWPADev_user', CAST(N'2025-06-17T14:37:02.323' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:32:50.490' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (21, 201, 7, 42, 18.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-01T12:33:41.500' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (22, 202, 7, 35, 18.0000, CAST(0.000 AS Decimal(6, 3)), 2, N'NWPADev_user', CAST(N'2025-07-01T12:35:14.417' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T16:09:45.440' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (23, 202, 35, 22, 19.5000, CAST(0.000 AS Decimal(6, 3)), 2, N'NWPADev_user', CAST(N'2025-07-01T13:16:35.537' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T16:09:45.440' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (24, 203, 4, 15, 12.4900, CAST(0.000 AS Decimal(6, 3)), 2, N'NWPADev_user', CAST(N'2025-07-04T05:34:57.210' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:32:50.490' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (27, 204, 7, 2, 18.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-04T05:38:37.953' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T16:34:49.107' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (28, 204, 24, 4, 2.9900, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-04T05:42:02.430' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T16:34:49.107' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (29, 204, 39, 4, 4.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-04T05:43:38.340' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T16:34:49.107' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (30, 204, 13, 6, 46.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-04T05:52:19.307' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T16:34:49.107' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (31, 204, 38, 6, 10.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-04T09:36:36.383' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T16:34:49.107' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (33, 206, 74, 30, 6.9900, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-07T10:45:18.573' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (34, 205, 81, 18, 36.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-07T13:10:11.483' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (35, 205, 80, 5, 35.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-07T13:10:42.147' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (37, 205, 76, 12, 36.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-07T13:23:31.000' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (38, 207, 82, 10, 48.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-07T15:54:42.630' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (39, 208, 13, 30, 46.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-07T15:56:48.630' AS DateTime), N'NWPADev_user', CAST(N'2025-07-14T15:50:54.130' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (40, 209, 83, 30, 6.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-09T12:21:01.857' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (41, 209, 13, 10, 46.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-09T12:25:20.460' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:31:34.917' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (43, 211, 6, 10, 15.9900, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-10T14:03:07.207' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:51:08.827' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (47, 212, 10, 25, 12.7500, CAST(0.000 AS Decimal(6, 3)), 2, N'NWPADev_user', CAST(N'2025-07-10T14:18:47.150' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T15:32:50.490' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (50, 213, 21, 5, 38.0000, CAST(0.020 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-12T06:17:49.923' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T16:33:14.820' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51, 213, 8, 12, 2.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-12T06:18:20.777' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T16:33:14.820' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (52, 211, 2, 10, 14.0000, CAST(0.040 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-22T10:57:00.523' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:51:08.827' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (53, 211, 15, 1, 18.4000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-22T11:02:13.017' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:51:08.827' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (54, 214, 84, 12, 48.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-27T15:29:45.647' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:31:32.370' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (55, 211, 86, 50, 36.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-27T15:50:22.107' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:51:08.827' AS DateTime))
GO
INSERT [dbo].[OrderDetails] ([OrderDetailID], [OrderID], [ProductID], [Quantity], [UnitPrice], [Discount], [OrderDetailStatusID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (56, 211, 84, 50, 48.0000, CAST(0.000 AS Decimal(6, 3)), 6, N'NWPADev_user', CAST(N'2025-07-27T15:50:39.567' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:51:08.827' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[OrderDetails] OFF
GO
SET IDENTITY_INSERT [dbo].[PurchaseOrderStatus] ON 
GO
INSERT [dbo].[PurchaseOrderStatus] ([StatusID], [StatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (1, N'Approved', 30, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderStatus] ([StatusID], [StatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (2, N'Closed', 50, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderStatus] ([StatusID], [StatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (3, N'New', 10, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderStatus] ([StatusID], [StatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (4, N'Submitted', 20, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderStatus] ([StatusID], [StatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (5, N'Received', 40, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderStatus] ([StatusID], [StatusName], [SortOrder], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (6, N'Cancelled', 60, N'NWPADev_user', CAST(N'2025-03-15T08:24:57.000' AS DateTime), N'NWPADev_user', CAST(N'2025-03-15T08:25:17.000' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[PurchaseOrderStatus] OFF
GO
SET IDENTITY_INSERT [dbo].[PurchaseOrders] ON 
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (91, 11, 5, CAST(N'2025-06-01T00:00:00.000' AS DateTime), 2, CAST(N'2025-06-02T00:00:00.000' AS DateTime), 2, CAST(N'2025-06-05T11:52:00.050' AS DateTime), 100.0000, 2908.1925, CAST(N'2025-06-05T11:52:42.377' AS DateTime), 35321.4425, N'Credit Card', N'Initial Product Purchase', N'NWPADev_user', CAST(N'2025-06-05T11:32:33.430' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T11:52:42.380' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (92, 12, 10, CAST(N'2025-06-11T15:58:25.290' AS DateTime), 2, CAST(N'2025-06-11T15:58:40.257' AS DateTime), 2, CAST(N'2025-06-11T15:58:43.950' AS DateTime), 0.0000, 224.1000, CAST(N'2025-06-11T15:58:51.113' AS DateTime), 2714.1000, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-06-11T15:57:45.580' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T15:58:51.113' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (93, 12, 10, CAST(N'2025-07-02T14:20:09.637' AS DateTime), 10, CAST(N'2025-07-02T14:20:09.637' AS DateTime), 2, CAST(N'2025-07-02T14:20:04.403' AS DateTime), 0.0000, 170.1000, CAST(N'2025-07-02T14:20:09.637' AS DateTime), 2060.1000, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-01T12:31:31.017' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:20:09.637' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (94, 11, 10, CAST(N'2025-07-02T14:30:59.947' AS DateTime), 2, CAST(N'2025-07-02T14:30:59.947' AS DateTime), 2, CAST(N'2025-07-02T14:30:56.673' AS DateTime), 0.0000, 280.8000, CAST(N'2025-07-02T14:30:59.947' AS DateTime), 3400.8000, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-02T14:28:25.037' AS DateTime), N'NWPADev_user', CAST(N'2025-07-03T09:06:28.613' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (96, 11, 10, CAST(N'2025-07-02T14:37:23.843' AS DateTime), 2, CAST(N'2025-07-02T14:37:23.843' AS DateTime), 2, CAST(N'2025-07-02T14:37:19.117' AS DateTime), 0.0000, 21.8250, CAST(N'2025-07-02T14:37:23.843' AS DateTime), 264.3250, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-02T14:32:04.017' AS DateTime), N'NWPADev_user', CAST(N'2025-07-03T09:06:30.343' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (97, 12, 10, CAST(N'2025-07-02T14:45:46.133' AS DateTime), 2, CAST(N'2025-07-02T14:44:00.030' AS DateTime), 2, CAST(N'2025-07-02T14:45:44.367' AS DateTime), 0.0000, 21.3750, CAST(N'2025-07-02T14:45:46.133' AS DateTime), 258.8750, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-02T14:43:36.270' AS DateTime), N'NWPADev_user', CAST(N'2025-07-03T09:06:31.420' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (98, 12, 10, CAST(N'2025-07-02T14:53:48.020' AS DateTime), 8, CAST(N'2025-07-02T14:52:00.890' AS DateTime), 2, CAST(N'2025-07-02T14:53:43.380' AS DateTime), 0.0000, 48.6000, CAST(N'2025-07-02T14:53:48.020' AS DateTime), 588.6000, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-02T14:46:43.873' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:53:48.020' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (99, 11, 10, CAST(N'2025-07-02T15:03:19.597' AS DateTime), 8, CAST(N'2025-07-02T15:01:55.123' AS DateTime), 2, CAST(N'2025-07-02T15:03:15.610' AS DateTime), 0.0000, 243.0000, CAST(N'2025-07-02T15:03:19.597' AS DateTime), 2943.0000, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-02T14:54:23.850' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:03:19.600' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (100, 11, 10, CAST(N'2025-07-02T15:08:37.137' AS DateTime), 8, CAST(N'2025-07-02T15:05:57.177' AS DateTime), 2, CAST(N'2025-07-02T15:08:32.750' AS DateTime), 0.0000, 486.0000, CAST(N'2025-07-02T15:08:37.137' AS DateTime), 5886.0000, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-02T15:04:51.723' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:08:37.147' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (101, 12, 10, CAST(N'2025-07-02T15:15:43.837' AS DateTime), 2, CAST(N'2025-07-02T15:14:53.960' AS DateTime), 2, CAST(N'2025-07-02T15:15:39.690' AS DateTime), 0.0000, 56.7000, CAST(N'2025-07-02T15:15:43.837' AS DateTime), 686.7000, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-02T15:09:13.940' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:15:43.837' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (102, 11, 10, CAST(N'2025-07-02T15:16:45.553' AS DateTime), 2, CAST(N'2025-07-02T15:16:37.597' AS DateTime), 2, CAST(N'2025-07-02T15:16:42.390' AS DateTime), 0.0000, 37.1250, CAST(N'2025-07-02T15:16:45.553' AS DateTime), 449.6250, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-02T15:16:04.983' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:16:45.553' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (103, 12, 10, CAST(N'2025-07-02T15:17:36.390' AS DateTime), 2, CAST(N'2025-07-02T15:17:28.860' AS DateTime), 2, CAST(N'2025-07-02T15:17:33.140' AS DateTime), 0.0000, 105.3000, CAST(N'2025-07-02T15:17:36.390' AS DateTime), 1275.3000, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-02T15:16:56.727' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:17:36.390' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (104, 12, 10, CAST(N'2025-07-02T15:19:38.993' AS DateTime), 2, CAST(N'2025-07-02T15:19:32.950' AS DateTime), 2, CAST(N'2025-07-02T15:19:35.967' AS DateTime), 0.0000, 317.9250, CAST(N'2025-07-02T15:19:38.993' AS DateTime), 3850.4250, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-02T15:18:47.260' AS DateTime), N'NWPADev_user', CAST(N'2025-07-03T09:08:39.680' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (114, 12, NULL, NULL, NULL, NULL, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, N'NWPADev_user', CAST(N'2025-07-07T09:50:21.267' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (116, 12, 10, CAST(N'2025-07-07T10:06:22.750' AS DateTime), 2, CAST(N'2025-07-07T10:06:16.657' AS DateTime), 2, CAST(N'2025-07-07T10:06:19.363' AS DateTime), 0.0000, 13.4550, CAST(N'2025-07-07T10:06:22.750' AS DateTime), 162.9550, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-07T09:59:22.683' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T10:06:22.763' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (117, 11, 10, CAST(N'2025-07-07T13:09:27.897' AS DateTime), 9, CAST(N'2025-07-07T13:09:17.997' AS DateTime), 2, CAST(N'2025-07-07T13:09:23.223' AS DateTime), 0.0000, 466.2000, CAST(N'2025-07-07T13:09:27.897' AS DateTime), 5646.2000, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-07T13:05:38.980' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T13:09:27.897' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (118, 12, 10, CAST(N'2025-07-07T15:52:48.220' AS DateTime), 2, CAST(N'2025-07-07T15:51:28.883' AS DateTime), 2, CAST(N'2025-07-07T15:51:49.073' AS DateTime), 0.0000, 243.0000, CAST(N'2025-07-07T15:52:48.220' AS DateTime), 2943.0000, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-07T15:50:08.760' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T15:52:48.220' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (120, 12, 10, CAST(N'2025-07-09T12:20:10.403' AS DateTime), 2, CAST(N'2025-07-09T12:19:56.550' AS DateTime), 2, CAST(N'2025-07-09T12:20:06.290' AS DateTime), 0.0000, 21.6000, CAST(N'2025-07-09T12:20:10.403' AS DateTime), 261.6000, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-09T12:18:46.293' AS DateTime), N'NWPADev_user', CAST(N'2025-07-09T12:20:10.407' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (121, 12, 10, CAST(N'2025-07-13T11:12:46.733' AS DateTime), NULL, NULL, 4, NULL, 0.0000, 0.0000, NULL, 0.0000, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-10T14:24:47.957' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T11:12:46.733' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (122, 12, 10, CAST(N'2025-07-27T15:49:32.993' AS DateTime), 9, CAST(N'2025-07-27T15:49:24.700' AS DateTime), 2, CAST(N'2025-07-27T15:49:28.620' AS DateTime), 16.0000, 428.2200, CAST(N'2025-07-27T15:49:32.993' AS DateTime), 5202.2200, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-10T14:24:51.297' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:49:32.993' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (123, 11, 10, CAST(N'2025-07-12T06:21:06.773' AS DateTime), 8, CAST(N'2025-07-12T06:20:59.280' AS DateTime), 2, CAST(N'2025-07-12T06:21:03.127' AS DateTime), 0.0000, 37.1250, CAST(N'2025-07-12T06:21:06.773' AS DateTime), 449.6250, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-10T14:26:17.983' AS DateTime), N'NWPADev_user', CAST(N'2025-07-12T06:21:06.777' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (124, 11, 10, CAST(N'2025-07-12T06:56:45.940' AS DateTime), 2, CAST(N'2025-07-12T06:56:39.520' AS DateTime), 2, CAST(N'2025-07-12T06:56:43.330' AS DateTime), 0.0000, 324.0000, CAST(N'2025-07-12T06:56:45.940' AS DateTime), 3924.0000, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-12T06:55:33.757' AS DateTime), N'NWPADev_user', CAST(N'2025-07-12T06:56:45.940' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (125, 12, 10, CAST(N'2025-07-13T11:09:37.647' AS DateTime), 2, CAST(N'2025-07-13T11:09:13.720' AS DateTime), 2, CAST(N'2025-07-13T11:09:24.960' AS DateTime), 0.0000, 62.0730, CAST(N'2025-07-13T11:09:37.647' AS DateTime), 751.7730, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-13T11:07:25.487' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T11:09:37.650' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (126, 12, 10, CAST(N'2025-07-13T11:18:29.200' AS DateTime), 2, CAST(N'2025-07-13T11:17:12.150' AS DateTime), 2, CAST(N'2025-07-13T11:18:24.243' AS DateTime), 0.0000, 141.0750, CAST(N'2025-07-13T11:18:29.200' AS DateTime), 1708.5750, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-13T11:15:27.077' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T11:18:29.200' AS DateTime))
GO
INSERT [dbo].[PurchaseOrders] ([PurchaseOrderID], [VendorID], [SubmittedByID], [SubmittedDate], [ApprovedByID], [ApprovedDate], [StatusID], [ReceivedDate], [ShippingFee], [TaxAmount], [PaymentDate], [PaymentAmount], [PaymentMethod], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (127, 11, 10, CAST(N'2025-07-27T15:13:16.107' AS DateTime), 2, CAST(N'2025-07-27T15:13:09.503' AS DateTime), 2, CAST(N'2025-07-27T15:13:13.093' AS DateTime), 0.0000, 291.6000, CAST(N'2025-07-27T15:13:16.107' AS DateTime), 3531.6000, N'Cash', NULL, N'NWPADev_user', CAST(N'2025-07-27T15:12:34.563' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:13:16.110' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[PurchaseOrders] OFF
GO
SET IDENTITY_INSERT [dbo].[ProductVendors] ON 
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (2, 2, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (3, 3, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (4, 4, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (5, 5, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (6, 6, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (7, 7, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (8, 8, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (9, 9, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (10, 10, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (11, 11, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (12, 12, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (13, 13, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (14, 14, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (15, 15, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (16, 16, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (17, 17, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (18, 18, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (19, 19, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (20, 20, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (21, 21, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (22, 22, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (23, 23, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (24, 24, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (25, 25, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (26, 26, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (27, 27, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (28, 28, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (29, 29, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (30, 30, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (31, 31, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (32, 32, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (33, 33, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (34, 34, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (35, 35, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (36, 36, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (37, 37, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (38, 38, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (39, 39, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (40, 40, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (41, 41, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (42, 42, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (43, 43, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (44, 1, 12, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (45, 1, 11, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (46, 2, 11, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (47, 3, 11, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (48, 4, 11, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (49, 59, 12, N'NWPADev_user', CAST(N'2025-06-29T15:43:07.287' AS DateTime), N'NWPADev_user', CAST(N'2025-06-29T15:47:07.063' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (50, 49, 12, N'NWPADev_user', CAST(N'2025-06-29T15:43:07.287' AS DateTime), N'NWPADev_user', CAST(N'2025-06-29T15:47:07.063' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51, 71, 12, N'NWPADev_user', CAST(N'2025-06-29T15:43:07.287' AS DateTime), N'NWPADev_user', CAST(N'2025-06-29T15:47:07.063' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (52, 56, 12, N'NWPADev_user', CAST(N'2025-06-29T15:43:07.287' AS DateTime), N'NWPADev_user', CAST(N'2025-06-29T15:47:07.063' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (53, 64, 12, N'NWPADev_user', CAST(N'2025-06-29T15:43:07.287' AS DateTime), N'NWPADev_user', CAST(N'2025-06-29T15:47:07.063' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (54, 44, 12, N'NWPADev_user', CAST(N'2025-06-29T15:43:07.287' AS DateTime), N'NWPADev_user', CAST(N'2025-06-29T15:47:07.063' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (55, 60, 12, N'NWPADev_user', CAST(N'2025-06-29T15:43:07.287' AS DateTime), N'NWPADev_user', CAST(N'2025-06-29T15:47:07.063' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (56, 47, 12, N'NWPADev_user', CAST(N'2025-06-29T15:43:07.287' AS DateTime), N'NWPADev_user', CAST(N'2025-06-29T15:47:07.063' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (57, 66, 12, N'NWPADev_user', CAST(N'2025-06-29T15:43:07.287' AS DateTime), N'NWPADev_user', CAST(N'2025-06-29T15:47:07.063' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (58, 73, 12, N'NWPADev_user', CAST(N'2025-06-29T15:43:07.287' AS DateTime), N'NWPADev_user', CAST(N'2025-06-29T15:47:07.063' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (59, 61, 12, N'NWPADev_user', CAST(N'2025-06-29T15:43:07.287' AS DateTime), N'NWPADev_user', CAST(N'2025-06-29T15:47:07.063' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (60, 76, 11, N'NWPADev_user', CAST(N'2025-07-13T10:07:49.343' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T10:15:53.523' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (61, 77, 11, N'NWPADev_user', CAST(N'2025-07-13T10:07:49.343' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T10:15:53.523' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (62, 83, 11, N'NWPADev_user', CAST(N'2025-07-13T10:07:49.343' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T10:15:53.523' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (63, 75, 11, N'NWPADev_user', CAST(N'2025-07-13T10:07:49.343' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T10:15:53.523' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (64, 80, 11, N'NWPADev_user', CAST(N'2025-07-13T10:07:49.343' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T10:15:53.523' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (65, 78, 11, N'NWPADev_user', CAST(N'2025-07-13T10:07:49.343' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T10:15:53.523' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (66, 74, 11, N'NWPADev_user', CAST(N'2025-07-13T10:07:49.343' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T10:15:53.523' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (67, 82, 11, N'NWPADev_user', CAST(N'2025-07-13T10:07:49.343' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T10:15:53.523' AS DateTime))
GO
INSERT [dbo].[ProductVendors] ([ProductVendorID], [ProductID], [VendorID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (68, 81, 11, N'NWPADev_user', CAST(N'2025-07-13T10:07:49.343' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T10:15:53.523' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[ProductVendors] OFF
GO
SET IDENTITY_INSERT [dbo].[Contacts] ON 
GO
INSERT [dbo].[Contacts] ([ContactID], [CompanyID], [LastName], [FirstName], [EmailAddress], [JobTitle], [PrimaryPhone], [SecondaryPhone], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (9, 1, N'Chauvin', N'Alexandre', N'test@test.com', N'Senior Buyer', N'1234567890 x1234', NULL, NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Contacts] ([ContactID], [CompanyID], [LastName], [FirstName], [EmailAddress], [JobTitle], [PrimaryPhone], [SecondaryPhone], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (11, 3, N'Eden', N'Bouchard', NULL, N'Dry Goods Rep', NULL, NULL, NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Contacts] ([ContactID], [CompanyID], [LastName], [FirstName], [EmailAddress], [JobTitle], [PrimaryPhone], [SecondaryPhone], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (13, 5, N'Fuster', N'Adriana', NULL, N'Sales Manager', NULL, NULL, NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Contacts] ([ContactID], [CompanyID], [LastName], [FirstName], [EmailAddress], [JobTitle], [PrimaryPhone], [SecondaryPhone], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (14, 6, N'Gagnon', N'Alex', NULL, N'Senior Buyer', NULL, NULL, NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Contacts] ([ContactID], [CompanyID], [LastName], [FirstName], [EmailAddress], [JobTitle], [PrimaryPhone], [SecondaryPhone], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (15, 7, N'Albert', N'Sasha', NULL, N'Vendor Relations', NULL, NULL, NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Contacts] ([ContactID], [CompanyID], [LastName], [FirstName], [EmailAddress], [JobTitle], [PrimaryPhone], [SecondaryPhone], [Notes], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (16, 8, N'Monte', N'Ariana', NULL, N'Senior Buyer', NULL, NULL, NULL, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[Contacts] OFF
GO
SET IDENTITY_INSERT [dbo].[Privileges] ON 
GO
INSERT [dbo].[Privileges] ([PrivilegeID], [PrivilegeName], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (1, N'Purchase Approvals', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Privileges] ([PrivilegeID], [PrivilegeName], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (2, N'Close for StockTake', N'NWPADev_user', CAST(N'2025-03-15T06:52:17.000' AS DateTime), N'NWPADev_user', CAST(N'2025-03-15T06:52:40.000' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[Privileges] OFF
GO
SET IDENTITY_INSERT [dbo].[EmployeePrivileges] ON 
GO
INSERT [dbo].[EmployeePrivileges] ([EmployeePrivilegeID], [EmployeeID], [PrivilegeID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (1, 2, 1, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[EmployeePrivileges] ([EmployeePrivilegeID], [EmployeeID], [PrivilegeID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (2, 9, 1, N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[EmployeePrivileges] ([EmployeePrivilegeID], [EmployeeID], [PrivilegeID], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (11, 8, 1, N'NWPADev_user', CAST(N'2025-03-15T06:29:02.000' AS DateTime), N'NWPADev_user', CAST(N'2025-03-15T06:29:22.000' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[EmployeePrivileges] OFF
GO
SET IDENTITY_INSERT [dbo].[PurchaseOrderDetails] ON 
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (1, 91, 1, 20, 7.5000, CAST(N'2025-06-05T11:52:00.050' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T11:32:33.443' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T11:52:42.450' AS DateTime))
GO
...
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51, 92, 4, 100, 9.0000, CAST(N'2025-06-11T15:58:43.950' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T15:57:57.950' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T15:58:51.117' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (52, 92, 2, 100, 10.5000, CAST(N'2025-06-11T15:58:43.950' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T15:58:09.060' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T15:58:51.117' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (53, 92, 7, 40, 13.5000, CAST(N'2025-06-11T15:58:43.950' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T15:58:17.770' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T15:58:51.117' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (54, 93, 71, 30, 36.0000, CAST(N'2025-07-02T14:20:04.403' AS DateTime), N'NWPADev_user', CAST(N'2025-07-01T13:39:39.540' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:20:09.637' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (55, 93, 7, 60, 13.5000, CAST(N'2025-07-02T14:20:04.403' AS DateTime), N'NWPADev_user', CAST(N'2025-07-01T13:39:57.203' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:20:09.637' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (56, 94, 7, 100, 13.5000, CAST(N'2025-07-02T14:30:56.673' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:29:02.400' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:30:59.947' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (57, 94, 13, 50, 34.5000, CAST(N'2025-07-02T14:30:56.673' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:29:26.490' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:30:59.947' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (58, 94, 14, 45, 1.0000, CAST(N'2025-07-02T14:30:56.673' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:30:06.010' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:30:59.947' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (59, 96, 24, 90, 2.0000, CAST(N'2025-07-02T14:37:19.117' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:32:44.783' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:37:23.843' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (60, 96, 64, 25, 2.5000, CAST(N'2025-07-02T14:37:19.117' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:32:57.197' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:37:23.843' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (62, 97, 64, 95, 2.5000, CAST(N'2025-07-02T14:45:44.367' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:43:48.013' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:45:46.137' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (64, 98, 66, 60, 9.0000, CAST(N'2025-07-02T14:53:43.380' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:47:06.027' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:53:48.023' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (65, 99, 73, 30, 90.0000, CAST(N'2025-07-02T15:03:15.610' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T14:54:37.190' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:03:19.600' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (66, 100, 73, 60, 90.0000, CAST(N'2025-07-02T15:08:32.750' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:05:04.477' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:08:37.150' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (67, 101, 6, 60, 10.5000, CAST(N'2025-07-02T15:15:39.690' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:09:27.440' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:15:43.837' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (68, 102, 5, 25, 16.5000, CAST(N'2025-07-02T15:16:42.390' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:16:19.933' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:16:45.553' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (69, 103, 20, 40, 29.2500, CAST(N'2025-07-02T15:17:33.140' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:17:08.833' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:17:36.390' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (73, 104, 1, 25, 7.5000, CAST(N'2025-07-02T15:19:35.967' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:18:53.680' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:19:38.993' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (74, 104, 2, 5, 10.5000, CAST(N'2025-07-02T15:19:35.967' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:18:58.617' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:19:38.993' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (75, 104, 3, 160, 18.7500, CAST(N'2025-07-02T15:19:35.967' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:19:05.027' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:19:38.993' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (76, 104, 4, 25, 9.0000, CAST(N'2025-07-02T15:19:35.967' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:19:11.267' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:19:38.993' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (77, 104, 7, 5, 13.5000, CAST(N'2025-07-02T15:19:35.967' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:19:18.010' AS DateTime), N'NWPADev_user', CAST(N'2025-07-02T15:19:38.993' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (79, 116, 74, 50, 2.9900, CAST(N'2025-07-07T10:06:19.363' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T10:06:00.683' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T10:06:22.770' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (81, 117, 81, 50, 22.0000, CAST(N'2025-07-07T13:09:23.223' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T13:06:22.917' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T13:09:27.900' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (82, 117, 76, 60, 20.0000, CAST(N'2025-07-07T13:09:23.223' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T13:06:42.103' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T13:09:27.900' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (83, 117, 78, 60, 30.0000, CAST(N'2025-07-07T13:09:23.223' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T13:06:58.370' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T13:09:27.900' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (84, 117, 80, 60, 18.0000, CAST(N'2025-07-07T13:09:23.223' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T13:07:24.060' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T13:09:27.900' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (85, 118, 82, 90, 30.0000, CAST(N'2025-07-07T15:51:49.073' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T15:51:00.940' AS DateTime), N'NWPADev_user', CAST(N'2025-07-07T15:52:48.223' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (86, 120, 83, 60, 4.0000, CAST(N'2025-07-09T12:20:06.290' AS DateTime), N'NWPADev_user', CAST(N'2025-07-09T12:19:29.683' AS DateTime), N'NWPADev_user', CAST(N'2025-07-09T12:20:10.407' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (88, 114, 6, 10, 10.5000, NULL, N'NWPADev_user', CAST(N'2025-07-10T14:22:45.293' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (89, 114, 5, 15, 16.5000, NULL, N'NWPADev_user', CAST(N'2025-07-10T14:24:19.733' AS DateTime), N'NWPADev_user', CAST(N'2025-07-10T14:24:29.110' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (90, 123, 5, 25, 16.5000, CAST(N'2025-07-12T06:21:03.127' AS DateTime), N'NWPADev_user', CAST(N'2025-07-12T06:19:16.053' AS DateTime), N'NWPADev_user', CAST(N'2025-07-12T06:21:06.777' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (91, 124, 77, 60, 60.0000, CAST(N'2025-07-12T06:56:43.330' AS DateTime), N'NWPADev_user', CAST(N'2025-07-12T06:56:17.817' AS DateTime), N'NWPADev_user', CAST(N'2025-07-12T06:56:45.943' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (92, 125, 74, 30, 2.9900, CAST(N'2025-07-13T11:09:24.960' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T11:07:43.213' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T11:09:37.650' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (93, 125, 76, 30, 20.0000, CAST(N'2025-07-13T11:09:24.960' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T11:08:10.693' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T11:09:37.650' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (94, 121, 5, 95, 16.5000, NULL, N'NWPADev_user', CAST(N'2025-07-13T11:12:42.783' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T11:12:46.733' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (95, 126, 5, 95, 16.5000, CAST(N'2025-07-13T11:18:24.243' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T11:15:46.830' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T11:18:29.200' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (96, 122, 4, 22, 9.0000, CAST(N'2025-07-27T15:49:28.620' AS DateTime), N'NWPADev_user', CAST(N'2025-07-22T10:23:50.303' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:49:32.993' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (97, 122, 49, 15, 16.0000, CAST(N'2025-07-27T15:49:28.620' AS DateTime), N'NWPADev_user', CAST(N'2025-07-22T10:39:44.740' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:49:32.993' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (98, 127, 84, 90, 36.0000, CAST(N'2025-07-27T15:13:13.093' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:12:53.003' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:13:16.110' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (99, 122, 85, 120, 12.0000, CAST(N'2025-07-27T15:49:28.620' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:48:49.990' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:49:32.993' AS DateTime))
GO
INSERT [dbo].[PurchaseOrderDetails] ([PurchaseOrderDetailID], [PurchaseOrderID], [ProductID], [Quantity], [UnitCost], [ReceivedDate], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (100, 122, 86, 120, 24.0000, CAST(N'2025-07-27T15:49:28.620' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:49:06.283' AS DateTime), N'NWPADev_user', CAST(N'2025-07-27T15:49:32.993' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[PurchaseOrderDetails] OFF
GO
SET IDENTITY_INSERT [dbo].[StockTake] ON 
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (688, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 1, 20, 20, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (689, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 2, 160, 160, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (690, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 3, 100, 100, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (691, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 4, 20, 20, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (692, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 5, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (693, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 6, 20, 20, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (695, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 8, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (696, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 9, 200, 200, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (697, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 10, 100, 100, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (698, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 11, 20, 20, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (699, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 12, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (700, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 13, 100, 100, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (701, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 14, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (702, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 15, 120, 120, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (703, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 16, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (704, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 17, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (705, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 18, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (706, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 19, 75, 75, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (707, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 20, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (708, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 21, 120, 120, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (709, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 22, 100, 100, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (710, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 23, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (711, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 24, 125, 125, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (712, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 25, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (713, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 26, 100, 100, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (714, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 27, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (715, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 28, 60, 60, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (716, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 29, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (717, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 30, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (718, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 31, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (719, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 32, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (720, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 33, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (721, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 34, 50, 50, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (723, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 36, 20, 20, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (724, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 37, 50, 50, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (725, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 38, 100, 100, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (726, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 39, 50, 50, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (727, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 40, 80, 80, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (728, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 41, 50, 50, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (729, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 42, 200, 200, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (730, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 43, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (731, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 44, 30, 30, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (732, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 47, 40, 40, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (733, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 49, 60, 60, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (734, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 56, 12, 12, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (735, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 59, 60, 60, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (736, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 60, 80, 80, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (737, CAST(N'2025-06-05T14:19:29.140' AS DateTime), 61, 60, 60, N'NWPADev_user', CAST(N'2025-06-05T11:32:33.467' AS DateTime), N'NWPADev_user', CAST(N'2025-06-05T14:19:29.170' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (747, CAST(N'2025-06-05T17:00:00.000' AS DateTime), 7, 38, 40, N'NWPADev_user', CAST(N'2025-06-05T16:49:43.480' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (761, CAST(N'2025-06-20T00:00:00.000' AS DateTime), 64, 0, 0, N'NWPADev_user', CAST(N'2025-06-20T11:02:52.307' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (764, CAST(N'2025-06-29T00:00:00.000' AS DateTime), 66, 0, 0, N'NWPADev_user', CAST(N'2025-06-29T11:01:52.230' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (768, CAST(N'2025-06-29T00:00:00.000' AS DateTime), 71, 0, 0, N'NWPADev_user', CAST(N'2025-06-29T11:26:14.220' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (773, CAST(N'2025-06-29T00:00:00.000' AS DateTime), 73, 0, 0, N'NWPADev_user', CAST(N'2025-06-29T12:23:23.300' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (816, CAST(N'2025-07-07T00:00:00.000' AS DateTime), 75, 0, 0, N'NWPADev_user', CAST(N'2025-07-07T11:49:41.557' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (821, CAST(N'2025-07-07T00:00:00.000' AS DateTime), 76, 0, 0, N'NWPADev_user', CAST(N'2025-07-07T12:30:53.013' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (823, CAST(N'2025-07-07T00:00:00.000' AS DateTime), 77, 0, 0, N'NWPADev_user', CAST(N'2025-07-07T12:43:31.033' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (826, CAST(N'2025-07-07T00:00:00.000' AS DateTime), 78, 0, 0, N'NWPADev_user', CAST(N'2025-07-07T12:49:21.087' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (845, CAST(N'2025-07-09T00:00:00.000' AS DateTime), 83, 0, 0, N'NWPADev_user', CAST(N'2025-07-09T12:17:13.460' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (873, CAST(N'2025-07-11T00:00:00.000' AS DateTime), 2, 230, 235, N'NWPADev_user', CAST(N'2025-07-13T10:24:21.083' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (882, CAST(N'2025-06-06T00:00:00.000' AS DateTime), 35, 80, 80, N'NWPADev_user', CAST(N'2025-07-13T13:04:30.050' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (883, CAST(N'2025-07-07T16:09:23.223' AS DateTime), 81, 50, 50, N'NWPADev_user', CAST(N'2025-07-13T16:06:15.070' AS DateTime), N'NWPADev_user', CAST(N'2025-07-31T11:43:11.740' AS DateTime))
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (890, CAST(N'2025-07-11T00:00:00.000' AS DateTime), 74, 20, 20, N'NWPADev_user', CAST(N'2025-07-14T13:38:50.443' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (892, CAST(N'2025-07-12T00:00:00.000' AS DateTime), 13, 34, 34, N'NWPADev_user', CAST(N'2025-07-14T15:52:57.987' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (895, CAST(N'2025-07-07T00:00:00.000' AS DateTime), 82, 90, 90, N'NWPADev_user', CAST(N'2025-07-15T06:28:19.670' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (896, CAST(N'2025-07-07T00:00:00.000' AS DateTime), 80, 60, 60, N'NWPADev_user', CAST(N'2025-07-15T06:48:40.770' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (898, CAST(N'2025-07-07T00:00:00.000' AS DateTime), 73, 90, 60, N'NWPADev_user', CAST(N'2025-07-15T06:53:38.803' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (910, CAST(N'2025-07-27T00:00:00.000' AS DateTime), 84, 0, 0, N'NWPADev_user', CAST(N'2025-07-27T15:09:51.480' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (916, CAST(N'2025-07-27T00:00:00.000' AS DateTime), 85, 0, 0, N'NWPADev_user', CAST(N'2025-07-27T15:42:07.933' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (919, CAST(N'2025-07-27T00:00:00.000' AS DateTime), 86, 0, 0, N'NWPADev_user', CAST(N'2025-07-27T15:47:20.590' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[StockTake] ([StockTakeID], [StockTakeDate], [ProductID], [QuantityOnHand], [ExpectedQuantity], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (936, CAST(N'2025-07-31T13:44:00.000' AS DateTime), 13, 28, 28, N'NWPADev_user', CAST(N'2025-07-31T13:44:20.757' AS DateTime), NULL, NULL)
GO
...
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (-100, N'Nothing to update or delete in {0}.', N'NWPADev_user', CAST(N'2025-07-26T05:12:46.390' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (-1, N'Invalid Input in {0}: Custom Error Code not found.', N'NWPADev_user', CAST(N'2025-06-26T05:52:19.250' AS DateTime), N'NWPADev_user', CAST(N'2025-07-03T11:50:46.997' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (0, N'Success: {0}', N'NWPADev_user', CAST(N'2025-04-18T11:55:42.227' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T12:09:01.720' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (102, N'Invalid Syntax in {0}. Please contact the developer for support.', N'NWPADev_user', CAST(N'2025-04-29T13:55:24.287' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T12:09:40.050' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (105, N'Invalid Syntax in {0}. Please contact the developer for support.', N'NWPADev_user', CAST(N'2025-04-29T14:26:21.933' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T12:09:15.583' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (201, N'A Required Value was not supplied for {0}.', N'NWPADev_user', CAST(N'2025-04-20T07:33:48.223' AS DateTime), N'NWPADev_user', CAST(N'2025-04-20T07:36:17.847' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (241, N'Invalid Syntax  in  {0}. Please contact the developer for support.', N'NWPADev_user', CAST(N'2025-04-29T14:28:26.010' AS DateTime), N'NWPADev_user', CAST(N'2025-04-29T14:28:30.537' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (515, N'Can''t Insert Null in required field(s) in {0}.', N'NWPADev_user', CAST(N'2025-04-15T10:37:59.010' AS DateTime), N'NWPADev_user', CAST(N'2025-04-20T07:11:19.440' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (547, N'Can''t Add, Update or Delete {0};  Either related data exists in other tables, required data is missing from other tables, or invalid values were submitted for one or more fields.', N'NWPADev_user', CAST(N'2025-04-15T10:39:00.190' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T15:53:20.400' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (2601, N'Can''t insert Duplicate Value in  {0}.', N'NWPADev_user', CAST(N'2025-04-14T17:56:33.107' AS DateTime), N'NWPADev_user', CAST(N'2025-04-20T07:11:22.190' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (8143, N'Invalid Syntax  in  {0}. Please Contact the developer for support.', N'NWPADev_user', CAST(N'2025-04-26T14:09:28.310' AS DateTime), N'NWPADev_user', CAST(N'2025-04-26T14:11:58.680' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (8144, N'Invalid Syntax  in  {0}. Please contact the developer for support.', N'NWPADev_user', CAST(N'2025-04-20T10:02:55.193' AS DateTime), N'NWPADev_user', CAST(N'2025-04-26T14:12:03.523' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (8145, N'Invalid Request in {0}.', N'NWPADev_user', CAST(N'2025-04-26T13:38:02.447' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (50000, N'Invalid table name specified {0}.', N'NWPADev_user', CAST(N'2025-05-01T20:47:05.680' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51000, N'The order containing this product has been invoiced and can''t be deleted {0}.', N'NWPADev_user', CAST(N'2025-05-02T13:52:39.067' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51100, N'{0}  has already been received and can''t be deleted', N'NWPADev_user', CAST(N'2025-06-20T11:45:10.443' AS DateTime), N'NWPADev_user', CAST(N'2025-06-20T11:45:34.430' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51200, N'{0} cannot be approved, received, or paid before they been submitted', N'NWPADev_user', CAST(N'2025-05-04T10:37:37.600' AS DateTime), N'NWPADev_user', CAST(N'2025-05-09T15:27:40.473' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51210, N'{0} cannot be received or paid before they been approved', N'NWPADev_user', CAST(N'2025-05-04T10:21:30.603' AS DateTime), N'NWPADev_user', CAST(N'2025-05-09T15:27:45.440' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51220, N'The Submitted Date for a {0} must be the earliest date for the {0}.', N'NWPADev_user', CAST(N'2025-05-04T11:26:26.637' AS DateTime), N'NWPADev_user', CAST(N'2025-06-29T10:00:29.927' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51230, N'{0}s can''t be submitted without one or more {0} Details', N'NWPADev_user', CAST(N'2025-05-04T09:55:13.640' AS DateTime), N'NWPADev_user', CAST(N'2025-06-29T10:01:06.547' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51240, N'The Approved Date must be on before the Received Date for {0}s', N'NWPADev_user', CAST(N'2025-05-04T12:32:44.367' AS DateTime), N'NWPADev_user', CAST(N'2025-05-09T05:10:43.450' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51250, N'The Approved Date must be on before the Payment Date for {0}s', N'NWPADev_user', CAST(N'2025-05-04T12:33:43.397' AS DateTime), N'NWPADev_user', CAST(N'2025-05-09T05:10:46.397' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51260, N'{0}s can''t be submitted without a Shipping Fee', N'NWPADev_user', CAST(N'2025-05-04T10:04:06.467' AS DateTime), N'NWPADev_user', CAST(N'2025-05-09T05:11:04.553' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51290, N'{0}s cannot be submitted without a Vendor', N'NWPADev_user', CAST(N'2025-06-29T10:02:23.397' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51300, N'To submit a {0}, indicate who submitted it. ', N'NWPADev_user', CAST(N'2025-05-06T15:26:46.017' AS DateTime), N'NWPADev_user', CAST(N'2025-05-09T05:11:15.430' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51310, N'To approve a {0}, indicate who approved it.  ', N'NWPADev_user', CAST(N'2025-05-06T17:40:45.493' AS DateTime), N'NWPADev_user', CAST(N'2025-05-09T05:11:27.357' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51330, N'Customer is required for {0}.', N'NWPADev_user', CAST(N'2025-06-06T05:23:19.673' AS DateTime), N'NWPADev_user', CAST(N'2025-06-06T05:25:33.427' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51340, N'Employee is required for {0}.', N'NWPADev_user', CAST(N'2025-06-06T05:24:58.770' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (52210, N'{0} Random Error', N'NWPADev_user', CAST(N'2025-05-04T10:48:06.297' AS DateTime), N'NWPADev_user', CAST(N'2025-05-09T05:11:53.233' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (52290, N'Select in proper Order: Submit a new {0}.', N'NWPADev_user', CAST(N'2025-05-09T05:01:35.100' AS DateTime), N'NWPADev_user', CAST(N'2025-05-10T19:25:05.420' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (52291, N'Select in proper Order: Approve submitted {0}', N'NWPADev_user', CAST(N'2025-05-10T19:24:30.777' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (52292, N'Select in proper Order: Receive approved {0}.', N'NWPADev_user', CAST(N'2025-05-10T19:25:50.463' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (52293, N'Select in proper Order: Close received {0}.', N'NWPADev_user', CAST(N'2025-05-10T19:26:23.790' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (52310, N'To approve a {0}, indicate who approved it.', N'NWPADev_user', CAST(N'2025-05-06T15:25:40.603' AS DateTime), N'NWPADev_user', CAST(N'2025-05-09T05:12:10.867' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (52601, N'Can''t insert Duplicate Value in  {0}.', N'NWPADev_user', CAST(N'2025-04-14T17:56:33.107' AS DateTime), N'NWPADev_user', CAST(N'2025-04-20T07:11:22.190' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (53230, N'{0} can''t be invoiced without one or more order details.', N'NWPADev_user', CAST(N'2025-05-08T15:50:29.617' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T11:32:10.680' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (53240, N'{0} cannot be invoiced 
without all Order Details allocated', N'NWPADev_user', CAST(N'2025-05-28T13:57:05.900' AS DateTime), N'NWPADev_user', CAST(N'2025-07-13T16:36:07.580' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (53260, N'{0} can''t be invoiced without a Ship fee.', N'NWPADev_user', CAST(N'2025-05-28T10:52:09.687' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T12:09:55.787' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (53270, N'{0} can''t be invoiced without a Shipper.', N'NWPADev_user', CAST(N'2025-05-09T06:56:30.953' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T12:10:01.913' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (53280, N'Indicate the Payment Method for the {0} and try again.', N'NWPADev_user', CAST(N'2025-05-08T16:29:58.710' AS DateTime), N'NWPADev_user', CAST(N'2025-05-09T05:12:35.080' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (53290, N'Select in proper sequence: create invoice for a new {0}.', N'NWPADev_user', CAST(N'2025-05-08T17:21:27.193' AS DateTime), N'NWPADev_user', CAST(N'2025-05-10T18:47:36.620' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (53291, N'Select in proper sequence: ship {0} after invoice', N'NWPADev_user', CAST(N'2025-05-10T18:48:28.090' AS DateTime), N'NWPADev_user', CAST(N'2025-05-10T18:48:34.000' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (53292, N'Select in proper sequence: receive payment after shipping {0}', N'NWPADev_user', CAST(N'2025-05-10T18:49:08.730' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (53293, N'Select in proper sequence: close {0} after receiving payment', N'NWPADev_user', CAST(N'2025-05-10T18:49:43.880' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (54000, N'{0} First Name is required.', N'NWPADev_user', CAST(N'2025-06-11T14:11:17.210' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T14:12:32.867' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (54100, N'{0} Last Name is required.', N'NWPADev_user', CAST(N'2025-06-11T14:11:38.093' AS DateTime), N'NWPADev_user', CAST(N'2025-06-11T15:52:13.797' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (54200, N'{0} Title is required.', N'NWPADev_user', CAST(N'2025-06-11T14:12:28.570' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (55000, N'{0} must be assigned to an order.', N'NWPADev_user', CAST(N'2025-07-04T05:02:25.060' AS DateTime), N'NWPADev_user', CAST(N'2025-07-04T05:04:33.683' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (55100, N'{0} Product is required.', N'NWPADev_user', CAST(N'2025-07-04T05:04:28.223' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (55200, N'{0} Unit Price is required.', N'NWPADev_user', CAST(N'2025-07-04T05:04:58.310' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (55300, N'{0} Quantity is required.', N'NWPADev_user', CAST(N'2025-07-04T05:40:48.067' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (55547, N'That Product is in Stock and can''t be deleted for {0}.', N'NWPADev_user', CAST(N'2025-04-27T08:50:38.453' AS DateTime), N'NWPADev_user', CAST(N'2025-04-27T08:51:37.687' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (56547, N'That Product has been previously sold and can''t be deleted for {0}.', N'NWPADev_user', CAST(N'2025-05-02T14:28:54.930' AS DateTime), NULL, NULL)
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (58000, N'This {0} already includes the selected product. Select a different product or change the quantity.', N'NWPADev_user', CAST(N'2025-06-17T11:42:33.893' AS DateTime), N'NWPADev_user', CAST(N'2025-06-17T11:43:11.510' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (58010, N'{0} Name is required.', N'NWPADev_user', CAST(N'2025-06-20T06:46:58.740' AS DateTime), N'NWPADev_user', CAST(N'2025-06-20T10:50:05.947' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (58020, N'{0} Standard Unit Cost is required.', N'NWPADev_user', CAST(N'2025-06-20T10:41:30.180' AS DateTime), N'NWPADev_user', CAST(N'2025-06-20T10:50:08.333' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (58030, N'{0) Unit Price is required.', N'NWPADev_user', CAST(N'2025-06-20T10:42:33.827' AS DateTime), N'NWPADev_user', CAST(N'2025-06-20T10:50:10.463' AS DateTime))
GO
INSERT [dbo].[SSErrors] ([SSErrorID], [SSError], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (58040, N'{0} Category is required.', N'NWPADev_user', CAST(N'2025-06-20T10:44:44.753' AS DateTime), N'NWPADev_user', CAST(N'2025-06-20T10:50:13.233' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[Strings] ON 
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (1, N'Hello {0}. This is {1}.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (2, N'Please enter a number between {0} and {1}.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (4, N'Only orders with status of Paid can be closed.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (5, N'OK to close this order?', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (6, N'An order can only be deleted before it is Shipped or Closed.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (7, N'Are you sure you want to permanently delete this {0}?', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (8, N'Record cannot be saved because not all required fields have been filled out. They are highlighted for your review.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (9, N'The order cannot be shipped until all Shipping related fields are filled out.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (10, N'Only orders with status of Invoiced can be shipped.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (11, N'There is no data for this report. Please try different criteria.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (12, N'{0} is not in the list of employees. If you want to add {0} as a supervisor, you must first add them as an employee.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (13, N'{0} {1} <br />
     {2}.<br /><br />', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (14, N'Confirm deletion of {0}.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (15, N'{0} is not a valid US phone number. Phone numbers must be formatted as either "(222) 333-444" or "555-6666"', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (16, N'The example companies, organizations, products, domain names, e-mail addresses, logos, people, places, and events depicted herein are fictitious.  No association with any real company, organization, product, domain name, email address, logo, person, places, or events is intended or should be inferred.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (17, N'The order cannot be invoiced until all line items have a status of Allocated. Allocation happens automatically when a PO is received with sufficient quantity.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (18, N'You are already on a new record.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (19, N'You don''t have the {0} privilege so you cannot perform this action. If you feel this is an error, discuss it with your supervisor. (TIP: login as Andrew Cencini, or give yourself rights in System Admin > Privileges)', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (20, N'The purchase order can only be submitted if it is in the New status.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (21, N'The purchase order can only be approved if it is in the Submitted status.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (22, N'Changing vendor will remove all purchase line items. OK to continue?', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (23, N'Has the entire purchase order been received, and are you ready to post to inventory? Orders waiting for these products will be updated.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (24, N'The purchase order can only be received if it is in the Approved status.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (25, N'The purchase order can only be closed if it is in the Received status.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (26, N'Shipping Fee and Payment Method are required before closing the purchase order.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (27, N'A purchase order can only be deleted when its Status is New or Submitted.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (28, N'This quantity is less than the Minimum Re-Order Quantity of {0}. That is not allowed.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (29, N'This quantity will result in an inventory level less than the Target Level of {0}. That is allowed but undesirable. Consider ordering at least {1} more.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (30, N'The new status has been set.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (32, N'Was the order paid today?', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (33, N'{0} ''{1}'' cannot be deleted because it has a related {2} record.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (34, N'An order must have at least one line item.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (35, N'You cannot change the Company Type if the Company has Orders/Purchase Orders.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (36, N'The order cannot be paid until all Payment related fields are filled out.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (37, N'You can''t {0} if the Company has<br />     Customer Orders ({1}) <br />     Shipper Orders ({2}) <br />     Vendor Purchase Orders ({3}) <br />     {4}  <br />', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (38, N'If you delete the Company any <br />     Contacts ({0}) <br />     and/or Vendor Products ({1}) will be deleted.<br /><br />    Is this OK?', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (39, N'This option is not available on a new order.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (40, N'If there are no recent orders, you may want to use Recent Dates on the System Admin form to move the dates of existing records forward.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
...
Please share your feedback with the team. We will be watching the Access Tech Community forum, as well as other forums where Access developers hang out.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (42, N'The form {0} is already open. Please close the form before opening a new {0}.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (43, N'Tour the Gastronomic World with Northwind Traders!', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
...
Our sales representatives are ready to take your orders now. For your convenience, we''ve included details on ordering on the last page of this catalog.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (45, N'Commitment to Quality', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (46, N'Northwind Traders is committed to bringing you products of the highest quality from all over the world. If at any time you are not completely satisfied with any of our products, you may return them to us for a full refund.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
...
for a mail-in, and then fax us at 1-206-555-5938.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (48, N'You have changed the data and not saved it.  Do you want to save it now? Selecting No will undo your changes.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (49, N'Only orders with status of Shipped can be paid.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (50, N'Only orders with status of New can be invoiced.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
INSERT [dbo].[Strings] ([StringID], [StringData], [AddedBy], [AddedOn], [ModifiedBy], [ModifiedOn]) VALUES (51, N'Please first complete the Order at the top of this form, before entering Order Line Items.', N'Admin', CAST(N'2024-09-21T00:00:00.000' AS DateTime), N'Admin', CAST(N'2024-10-25T12:30:06.000' AS DateTime))
GO
